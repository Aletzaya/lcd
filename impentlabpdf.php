...
$html='<table align="center" width="100%" border="0"><tr><td align="left"><b> No.Entrada: </b>'.$He[id].'</td><td align="left"><b>Fecha: </b>'.$He[fecha].' - '.$He[hora].'</td><td align="left"><b>Almacen: </b>'.$almacen.'</td></tr></table>';
...
$HilA=mysql_query("SELECT id,alias,nombre from prv where id='$He[proveedor]'");
