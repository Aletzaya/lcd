     ...
     $lUp    = mysql_query("delete FROM conest WHERE estudio='$busca' and id='$_REQUEST[id]'",$link);
          ...
          $UpA=mysql_query($cSql2,$link);
            ...
            if(!$res2=mysql_fetch_array($UpA)){
              ...
              $lUp2=mysql_query("INSERT into $tablasuc (estudio,equipo,tecnica,maquila1,maquila2,maquila3,mixtolcd,mixtotpx,mixtohf,mixtorys,mixtomaq) VALUES ('$busca','$_REQUEST[Equipo]','$_REQUEST[Tecnica]','$_REQUEST[Maquila1]','$_REQUEST[Maquila2]','$_REQUEST[Maquila3]','$_REQUEST[Mixtolcd]','$_REQUEST[Mixtotpx]','$_REQUEST[Mixtohf]','$_REQUEST[Mixtorys]','$_REQUEST[Mixtomaq]')",$link);
...
<?php if($opm=='basicos'){?>
  <li><?php echo "<a href=estudiose2.php?opm=basicos&busca=$_REQUEST[busca] class=current>Datos Basicos</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=basicos&busca=$_REQUEST[busca]>Datos Basicos</a>"; ?></li>
<?php }?>

<?php if($opm=='equipos'){?>
  <li><?php echo "<a href=estudiose2.php?opm=equipos&busca=$_REQUEST[busca] class=current>Equipos por Unidad</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=equipos&busca=$_REQUEST[busca]>Equipos por Unidad</a>"; ?></li>
<?php }?>

<?php if($opm=='muestras'){?>
    <li><?php echo "<a href=estudiose2.php?opm=muestras&busca=$_REQUEST[busca] class=current>Muestras</a>"; ?></li>
<?php }else{?>
    <li><?php echo "<a href=estudiose2.php?opm=muestras&busca=$_REQUEST[busca]>Muestras</a>"; ?></li>
<?php }?>

<?php if($opm=='contenido'){?>
  <li><?php echo "<a href=estudiose2.php?opm=contenido&busca=$_REQUEST[busca] class=current>Contenido</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=contenido&busca=$_REQUEST[busca]>Contenido</a>"; ?></li>
<?php }?>

<?php if($opm=='general'){?>
  <li><?php echo "<a href=estudiose2.php?opm=general&busca=$_REQUEST[busca] class=current>Descripcion general</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=general&busca=$_REQUEST[busca]>Descripcion general</a>"; ?></li>
<?php }?>

<?php if($opm=='admin'){?>
  <li><?php echo "<a href=estudiose2.php?opm=admin&busca=$_REQUEST[busca] class=current>Administracion</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=admin&busca=$_REQUEST[busca]>Administracion</a>"; ?></li>
<?php }?>

<?php if($opm=='promocion'){?>
  <li><?php echo "<a href=estudiose2.php?opm=promocion&busca=$_REQUEST[busca] class=current>Atn clientes/Promocion</a>"; ?></li>   
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=promocion&busca=$_REQUEST[busca]>Atn clientes/Promocion</a>"; ?></li>   
<?php }?>

<?php if($opm=='elementos'){?>
  <li><?php echo "<a href=estudiose2.php?opm=elementos&busca=$_REQUEST[busca] class=current>Elementos de Cap./Imp.</a>"; ?></li>   
<?php }else{?>
  <li><?php echo "<a href=estudiose2.php?opm=elementos&busca=$_REQUEST[busca]>Elementos de Cap./Imp.</a>"; ?></li>   
<?php }?>
...
/***   Proceso y clasificacion   ***/
      ...
      echo "<tr border='1'><td align='center' bgcolor=$colorm1><a href='estudiose2.php?suc=1&busca=$busca&opm=equipos'>$Gfont LCD-TX &nbsp;</font></a></td>
    <td align='center' bgcolor=$colorm2><a href='estudiose2.php?suc=2&busca=$busca&opm=equipos'>$Gfont LCD-TPX &nbsp;</font></a></td>
    <td align='center' bgcolor=$colorm3><a href='estudiose2.php?suc=3&busca=$busca&opm=equipos'>$Gfont LCD-HF &nbsp;</font></a></td>
    <td align='center' bgcolor=$colorm4><a href='estudiose2.php?suc=4&busca=$busca&opm=equipos'>$Gfont LCD-LR &nbsp;</font></a></td></tr>";
     ...
     echo "<tr><td align='right' colspan='2'>$Gfont Tecnica: </td><td>";
      ...
      if($Cpo[bloqeqp]=='No'){
          ...
          echo "<tr><td align='center' colspan='4'><a href=estudiose2.php?busca=$busca&opm=equipos&op=cerrareqp&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='Actualiza'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose2.php?busca=$busca&opm=equipos&op=abrireqp&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
      ...
      echo "<tr border='1'><td align='center' bgcolor=$colorm1><a href='estudiose2.php?ele=1&busca=$busca&opm=elementos'>$Gfont Elementos PDF Standard &nbsp;</font></a></td>
      <td align='center' bgcolor=$colorm2><a href='estudiose2.php?ele=2&busca=$busca&opm=elementos'>$Gfont Elementos PDF-Alternativo &nbsp;</font></a></td>
      <td align='center' bgcolor=$colorm3><a href='estudiose2.php?ele=3&busca=$busca&opm=elementos'>$Gfont Elementos PDF-Alternativo 2 &nbsp;</font></a></td></tr>";
