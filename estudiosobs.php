<?php
  ...
  $Titulo = "Informacion Importante del Estudio: ".$estudio." - ".$Cpo[descripcion];
...
$pdf->SetFont('Helvetica', '', 10, '', 'false');
 ...
 $Objetivo=utf8_encode($Objetivo); //Coloca la primer letra en mayuscula en un parrafo
 ...
 $Condiciones=utf8_encode($Condiciones); //Coloca la primer letra en mayuscula en un parrafo
 ...
 $Contenido=utf8_encode($Contenido); //Coloca la primer letra en mayuscula en un parrafo
 ...
 $Observaciones=utf8_encode($Observaciones); //Coloca la primer letra en mayuscula en un parrafo
