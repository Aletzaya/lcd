...
<table width="100%" height="813" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="Estilo18">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td colspan="4" rowspan="2"><?php echo "<form action='ordenesnvasN.php?Vta=$Vta&op=br' method='post' name='manda' class='Estilo31'>"?>
        <div align="center">
          <input type="submit" name="manda" value="Orden #<?php echo "$Suc-$Ot[institucion]-$busca";?>" onClick="print()">
           <br>
...
?>
  ...
  <tr bordercolor="#FFFFFF">
    <td colspan="3" rowspan="11" bordercolor="#CCCCCC"><div align="center" class="Estilo31"></div>
        <div align="center" class="Estilo31"><img src="Promooct2017.jpg" width="300" height="241"></div></td>
