...
while ($registro = mysql_fetch_array($res)) {
    ...
    echo "<tr bgcolor='$Fdo' onMouseOver=this.style.backgroundColor='$Gbarra';this.style.cursor='hand' onMouseOut=this.style.backgroundColor='$Fdo';>";
  	if($registro[activo]=='No'){
    	...
    	echo "<td>$Gfont <a class='pg' href='ordenesnvas.php?op=Estudio&Estudio=$registro[estudio]'>Seleccionar</a></td>";
	}
...
echo "<a  class='pg'  href='$_SERVER[PHP_SELF]?pagina=0&Sort=Asc&orden=est.estudio&busca=&filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*&Inst=$Inst'>Limpia pantalla</a></div>";
