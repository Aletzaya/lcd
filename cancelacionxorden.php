...
<form name="form1" method="post" action="cancelacionxorden.php?op=rmd">
...
<form name="form2" method="post" action="cancelacionxorden.php?op=cnc">
  <div align="center">
...
<form name="form3" method="post" action="cancelacionxorden.php?op=en">
