...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      $res  = mysql_query($sql);
	  	  ...
	  	  echo "<table align='right' width='50%' border='0' cellspacing='0' cellpadding='0' background='lib/degrada.jpg'>";

          echo "<tr align='right'>";
		  echo "<td align='right'>$Gfont<b><font size='1' color='#009900'>Ruta</b></font>";
    	  echo "<form name='form' method='post' action='medicos2.php?pagina=$pagina&Sort=Asc&busca=$busca&filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=$filtro9'>";
