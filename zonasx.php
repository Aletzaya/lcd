...
<?
  ...
  if(!$res=mysql_query($cSql.$cWhe,$link)){
        ...
        echo "<p align='center'><font face='verdana' size='-2'><a href='zonas.php?op=br'>";
        ...
        echo "<th bgcolor='#6633FF'><a class='ord' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&busca=".$busca."&orden=poblacion'>Poblacion Aprox</a></th>";
        ...
        <td><a href=<?php echo 'zonasd.php?busca='.$registro[zona].'&pagina='.$pagina; ?>><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#0066FF"><b>Detalle</b></font></a></td>
        <td><a href=<?php echo 'zonase.php?busca='.$registro[zona].'&pagina='.$pagina; ?>><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#0066FF"><b><? echo $registro[zona]; ?></b></font></a></td>
        <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#0066FF"><b><? echo $registro[descripcion]; ?></b></font></td>
        <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#0066FF"><b><? echo $registro[poblacion]; ?></b></font></td>
        </tr>
  ...
  <tr bgcolor="#CEDADD">
    <td width="11%" height="86">
      <form name="form1" method="post" action=<?$_SERVER["PHP_SELF"]?>>
        ...
        <ord align="center"><font class="ord" face="verdana" size="-2"><a class="ord" href="zonas.php?op=br">Recarga y/ò limpia</a></font>
        </p>
        <input type="hidden" name="pagina" value="1" >
        <input type="hidden" name="inicio" value ="1" >
      </form></td>
      <td width="7%"><div align="center"><a href="zonase.php?busca=NUEVO&pagina=<? echo $pagina;?>"><img src="imagenes/Agrega.gif" alt="Agrega nvo.registro" width="48" height="47" border="0"></a></div></td>
      <td width="58%"> <form name="form2" method="get" action=<?$_SERVER["PHP_SELF"]?>>
        ...
        <select name="Campo">
          ...
          <option value="Nzns.zona">Zona</option>
          <option value="Czns.descripcion">Descripcion</option>
          <option value="Nzns.poblacion">Poblacion</option>
        </select>
        <select name="Signo">
      ...
      <td width="24%">
	  <form name='form3' method='get' action='zonas.php' onSubmit='return ValSuma();'>
        <p>
