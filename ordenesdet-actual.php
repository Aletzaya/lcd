...
//						} 
   ...
   echo "<tr bgcolor ='#618fa9'>";
	  ...
	  if($He[idprocedencia]=='ambu'){
	      $alerta=" <img src='images/ambu.png' width='30' height='30'>";
	  }elseif($He[idprocedencia]=='silla'){
	      $alerta=" <img src='images/silla.png' width='30' height='30'>";
	  }elseif($He[idprocedencia]=='terceraedad'){
	      $alerta=" <img src='images/terceraedad.png' width='30' height='30'>";
	  }elseif($He[idprocedencia]=='problemasv'){
	      $alerta=" <img src='images/problemasv.png' width='30' height='30'>";
	  }else{
	      $alerta=" ";
	  }

	echo "<td width='3%' align='center' bgcolor ='#FFFFFF'>$alerta";
	echo "</td>";
