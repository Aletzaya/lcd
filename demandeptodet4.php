...
<body bgcolor="#FFFFFF">
  ...
  echo "<hr noshade style='color:000099;height:1px'>";
	echo "<form name='form' method='post' action='demandeptodet4.php'>";
 ...
 echo "<td align='center' colspan='9'>$Gfont <font size='1'><b>De:</b></font><input type='text' readonly='readonly' name='FechaI' size='10' value ='$FechaI'> <img src='lib/calendar.png' border='0' onclick=displayCalendar(document.forms[0].FechaI,'yyyy-mm-dd',this)>";
  ...
  echo "<br>";
//   echo "<form name='form1' method='post' action='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=$filtro9&FechaI=$FechaI&FechaF=$FechaF'>";

   echo "$Gfont <b> <a class='pg2' href='demandeptodet4.php?filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marcat><font size='1'>&nbsp;&nbsp; * - TODOS DEPTOS &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg2' href='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=1&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marca1><font size='1'>&nbsp;&nbsp; LABORATORIO &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg2' href='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=2&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marca2><font size='1'>&nbsp;&nbsp; RAYOS X Y USG &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg2' href='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=3&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marca3><font size='1'>&nbsp;&nbsp; ESPECIALES &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg2' href='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=4&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marca4><font size='1'>&nbsp;&nbsp; SERVICIOS &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg2' href='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=6&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marca6><font size='1'>&nbsp;&nbsp; EXTERNOS &nbsp;&nbsp;</b></a>";
  ...
  echo "$Gfont <b><a class='pg2' href='demandeptodet4.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador&submenu=1'><font color=$marcat><font size='1'>&nbsp; TODOS SUBDEPTOS &nbsp;</b></a>";
  ...
  while ($Subdepto=mysql_fetch_array($SubA)){
      if ($Subdepto[subdepto]==$filtro9){
          ...
          echo "$Gfont <b><a class='pg2' href='demandeptodet4.php?filtro=$filtro&contador=$contador&filtroF=$filtroF&filtro3=$filtro3&filtro5=$filtro5&FechaI=$FechaI&FechaF=$FechaF&filtro7=$filtro7&filtro9=$filtroF&HoraI=$HoraI&HoraF=$HoraF&filtroG=$filtroG&submenu=1'><font size='1' color='#003399'>&nbsp; $Subdepto[subdepto] &nbsp;</font></b></a>";
      }elseif ($Subdepto[subdepto]==$filtroF){
          $contador=1;
          echo "$Gfont <b><a class='pg2' href='demandeptodet4.php?filtro=$filtro&contador=$contador&filtroF=$filtro9&filtro3=$filtro3&filtro5=$filtro5&FechaI=$FechaI&FechaF=$FechaF&filtro7=$filtro7&filtro9=$filtro9&HoraI=$HoraI&HoraF=$HoraF&filtroG=$filtroG&submenu=1'><font size='1' color='#003399'><font size='1' color='#003399'>&nbsp; $Subdepto[subdepto] &nbsp;</font></b></a>";
      }elseif ($Subdepto[subdepto]==$filtroG){
          echo "$Gfont <b><font size='1' color='#003399'>&nbsp; $Subdepto[subdepto] &nbsp;</font></b></a>";
      }else{
        echo "$Gfont <b><a class='pg2' href='demandeptodet4.php?filtro=$filtro&contador=$contador&filtroF=$filtro9&filtro3=$filtro3&filtro5=$filtro5&FechaI=$FechaI&FechaF=$FechaF&filtro7=$filtro7&filtro9=$Subdepto[subdepto]&HoraI=$HoraI&HoraF=$HoraF&filtroG=$filtroG&submenu=1'><font size='1'>&nbsp; $Subdepto[subdepto] &nbsp;</font></b></a>";
      }
  }
