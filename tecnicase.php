  ...
  if($_REQUEST[Boton] == Aceptar or $_REQUEST[Boton] == Aplicar ){        //Para agregar uno nuevo
	  ...
	  if($busca=="NUEVO"){
          ...
          if($_REQUEST[Tecnica]<>""){
             ...
             $lUp=mysql_query("insert into $Tabla (tecnica,observaciones) VALUES
             ('$_REQUEST[Tecnica]','$_REQUEST[Observaciones]')",$link);
          ...
          $lUp=mysql_query("update $Tabla set tecnica='$_REQUEST[Tecnica]',observaciones='$_REQUEST[Observaciones]' where id='$busca' limit 1",$link);
          $lBd=true;
      }

  }elseif($_REQUEST[Boton] == Cancelar){    // Para dar de baja

           header("Location: tecnicas.php?busca=$busca&Sort=Asc&orden=id");
...
if (cCampo=='Tecnica'){document.form1.Tecnica.value=document.form1.Tecnica.value.toUpperCase();}
...
echo "<table width='100%' border='0'>";
  ...
  echo "<tr>";
    ...
    echo "<td width='10%' align='center'>";
        ...
        echo "<a href='tecnicas.php?busca=$busca&Sort=Asc&orden=id'><img src='lib/regresar.gif' border='0'></a>";

    echo "</td>";

    echo "<td>";

       echo "<form name='form1' method='get' action='tecnicase.php' onSubmit='return ValCampos();'>";

             echo $Gfont;
             echo "<p> &nbsp; &nbsp; &nbsp; Cuenta: &nbsp; $busca &nbsp; &nbsp; &nbsp; Tecnica............: &nbsp; ";
             echo "<input type='text' name='Tecnica' value='$Cpo[tecnica]' onBlur=Mayusculas('Tecnica') size='40'></p>";
