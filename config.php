...
$Gletra2     = '#555555';       // Color de la letra dentro del grid
...
$Gfont4      = "<font size='2' face='Verdana, Arial, Helvetica, sans-serif' color=$Gletra2> &nbsp;";
$Gfont3      = "<font size='1' face='Verdana, Arial, Helvetica, sans-serif' color=$Gletra2> &nbsp;";
$Gfont2      = "<font size='-2' face='Verdana, Arial, Helvetica, sans-serif' color=$Gletra> &nbsp;";

$MargenIzq  = 20;	   //Margen Izquierdo;
$MargenAlt  = 20;		//Margen de la altura Top; 
...
$Gfon = " &nbsp; </font>";
    ...
    echo "window.open(url,'filtros','status=no,tollbar=yes,scrollbars=yes,menubar=no,width=1000,height=400,left=100,top=80')";
    echo "}";
