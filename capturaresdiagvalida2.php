	...
	if($Otd[capturo]<>''){
       ...
       if($_REQUEST[Confirmacion]<>''){
		 ...
		 if($Acc[uname] == $Usr){     
				...
				$Up = mysql_query("UPDATE otd SET fechavalida = '$Fecha $Hora', usrvalida='$Usr',alterno='$alterno',fr='$fr2'
			...
			$Msj = $Msj . "<br>Lo siento! tu confirmacion no es correcta</br>";			    	
                ...
                $Up = mysql_query("UPDATE otd SET tres = '$Fecha $Hora', status='TERMINADA', capturo='$Usr',alterno='$alterno',fr='$fr2'
	                   WHERE orden='$busca' and estudio='$estudio'");   
	}
...
function elegir() {
 ...
 alert('no se borra nada');
	...
	if($alterno==0){				
    	...
    	echo "<div align='center'>$Gfont <font color='#330099'><b> Captura Standar: <a class='pg' href='capturaresdiagvalida2.php?busca=$busca&estudio=$estudio&alterno=0'><img src='lib/iconfalse.gif'></b></a>";
    }   

	if($alterno==1){				
       	echo "$Gfont <font color='#330099'><b> Captura Alternativa: <img src='lib/slc.png'>";
    }else{
    	echo "$Gfont <font color='#330099'><b> Captura Alternativa: <a class='pg' href='capturaresdiagvalida2.php?busca=$busca&estudio=$estudio&alterno=1'><img src='lib/iconfalse.gif'></b></a>";
    }   

	if($alterno==2){				
       	echo "$Gfont <font color='#330099'><b> Captura Alternativa (2): <img src='lib/slc.png'></div><br>";
    }else{
    	echo "$Gfont <font color='#330099'><b> Captura Alternativa (2): <a class='pg' href='capturaresdiagvalida2.php?busca=$busca&estudio=$estudio&alterno=2'><img src='lib/iconfalse.gif'></b></a></div><br>";
    }   

    echo "<form name='form1' method='post' action='capturaresdiagvalida2.php?alterno=$alterno'>";
