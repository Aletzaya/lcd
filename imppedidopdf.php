...
$Team='LCD - Matriz';
$pdf->SetHeaderData('logo.jpg', '45', '    Laboratorio Clinico Duran S.A. de C.V.','                                                                                                                                                 Movimiento al almacen                                                           Concepto: '.$He[concepto]);//define ("PDF_HEADER_LOGO", "logo_example.png");
...
$html='<table align="center" width="100%" border="0"><tr><td align="left"><b> No.Pedido: </b>'.$He[id].'</td><td align="left"><b>Fecha: </b>'.$He[fecha].' - '.$He[hora].'</td><td align="left"><b>Almacen: </b>'.$He[unidad].'</td></tr></table>';
...
while( $rg = mysql_fetch_array($res) ){
  ...
  $html='<table align="center" width="100%" border="0"><tr style="background-color: '.$Fdo.';color: #000;"><td align="left" width="120" height="30">'.$rg[clave].'</td><td align="left" width="400">'.$rg[descripcion].'</td><td align="center" width="100">'.$rg[cantidad].'</td><td align="right" width="130">'.number_format($rg[costo]/$rg2[pzasmedida],"2").'</td><td align="right" width="130">'.number_format(($rg[costo]/$rg2[ pzasmedida])*$rg[cantidad],"2").'</td><td align="center" width="130">'.$rg[existencia].'</td><td align="center" width="130"><font color='.$colorletra.'>'.$staped.'</font></td></tr></table>';
...
$html='<table align="center" width="100%" border="0"><tr style="background-color: #0d486a; color:#FFF;"><td align="center" width="120" height="30"></td><td align="center" width="400"><b>Productos registrados: '.number_format($nRng,"0").'</b></td><td align="center" width="100"><b>'.number_format($Cantidad,"0").'</b></td><td align="right" width="130"><b>'.number_format($Costo,"2").'</b></td><td align="right" width="130"><b>'.number_format($Importe,"2").'</b></td><td align="center" width="130"></td><td align="center" width="130"></td></tr></table>';
