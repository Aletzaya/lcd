...
//  echo "&nbsp; <input type='hidden' name='filtro3' value='$filtro3'>";
  ...
  <td align='center' colspan='3'>$Gfon <b>Diferencia</b></td></tr><tr bgcolor='#a2b2de'><td align='center'>$Gfon <b>Estudio</b></td><td align='center' colspan='2'>$Gfon <b>Descripcion</b></td>
	<td align='center'>$Gfon <b>Ordenes</b></td><td align='center'>$Gfon <b>Cant</b></td><td align='center'>$Gfon <b>Importe</b></td><td align='center'>$Gfon <b>Ordenes</b></td><td align='center'>$Gfon <b>Cant</b></td><td align='center'>$Gfon <b>Importe</b></td><td align='center'>$Gfon <b>Cant Ord</b></td><td align='center'>$Gfon <b>Cantidad</b></td><td align='center'>$Gfon <b>Importe</b></td></tr>";
    ...
    //echo "<table width='100%' align='center' border='0'>";
  	...
  	while ($reg1 = mysql_fetch_array($est3)) {
        ...
        $difcant2=$canti3-$canti4;
			...
			<td align='center'>$Gfont $reg1[institucion]</td><td colspan='2'>$Gfont $reg1[alias] </font></td><td align='center'>$Gfont $canti3<font size='1'></font></td><td align='center'>$Gfont $canti1<font size='1'></font></td><td align='right'>$Gfont ".number_format($importotal1,'2')."</font></td><td align='center'>$Gfont $canti4</font><td align='center'>$Gfont $canti2</font></td><td align='right'>$Gfont ".number_format($importotal2,'2')."</font></td><td  align='center'>$Gfont $difcant2</font></td><td  align='center'>$Gfont $difcant</font></td><td align='right'>$Gfont ".number_format($difimport,'2')."</font></td></tr>";
	...
	<td align='center'>$Gfon <b>$cantit3</b></td><td align='center'>$Gfon <b>$cantit1</b></td><td align='right'>$Gfon <b>$ ".number_format($importotalt1,'2')."</b></td><td align='center'>$Gfon <b>$cantit4</b><td align='center'>$Gfon <b>$cantit2</b></td><td align='right'>$Gfon <b>$ ".number_format($importotalt2,'2')."</b></td><td align='center'>$Gfon <b>$cantit6</b></td><td align='center'>$Gfon <b>$cantit5</b></td><td align='right'>$Gfon <b>$ ".number_format($importotalt3,'2')."</b></td></tr>";
