...
<?php
    ...
    while($rg=mysql_fetch_array($UpA)) {
		...
		echo "<th></th>"; 
		echo "<th></th>"; 
		echo "<th align='center' bgcolor=$color2><font color='#336600' size='1' face='Arial, Helvetica, sans-serif'>$diferencia</font></th>";
   		echo "</tr>"; 
   		echo "<tr></tr>"; 
   		echo "<tr></tr>"; 
   		echo "<tr></tr>"; 
