...
while($Otd = mysql_fetch_array($OtdA)){
     ...
     echo "<td width='100%' height='50' align='center'>";
        ...
        echo "<input name='Imp' face='Courier New, Courier, mono' type='submit' onClick='print()' value='No.Orden: $Ot[institucion] - $busca'><font size='1'>$Hora";
		  ...
		  echo "<div align='center'><strong><font size='1' face='Courier New, Courier, mono'>$Otd[1]<div></strong>";
		 
		  echo "<div align='center'><font size='1' face='Courier New, Courier, mono'><strong><u> $Otd[0] </u><font size='1' face='Courier New, Courier, mono'>- <u> $serv </u><div></strong>";
