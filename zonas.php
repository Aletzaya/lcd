<?php
  ...
  if($Palabras > 1){
     ...
     for ($i = 0; $i < $Palabras; $i++) {
            if(!isset($BusInt)){$BusInt=" zns.descripcion like '%$P[$i]%' ";}else{$BusInt=$BusInt." and zns.descripcion like '%$P[$i]%' ";}
     }
  }else{
     $BusInt=" zns.descripcion like '%$busca%' ";  
  }
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           //echo "<td align='center'><a href='$cLinkd?busca=$rg[zona]'><img src='lib/browse.png' alt='Detalle' border='0'></td>";
           //echo "<td align='center'><a href=ordenesnvas.php?Cliente=$rg[cliente]&op=cl><img src='lib/ok.png' alt='Elige este reg' border='0'></td>";

           echo "<td align='center'><a href=zonase.php?busca=$rg[zona]&pagina=$pagina><img src='lib/edit.png' alt='Edita reg' border='0'></a></td>";
           echo "<td align='center'><a href=zonasd.php?busca=$rg[zona]&pagina=$pagina><img src='lib/browse.png' alt='Detalle' border='0'></a></td>";
