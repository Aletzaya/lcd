...
global $pagina,$cFuncion,$numeroRegistros,$orden,$busca,$Edit;   #P k reconoscan el valor k traen
      ...
      echo "<table align='center' width='100%' border='0' cellspacing='1' cellpadding='0'>";
        ...
        echo "<tr height='25' bgcolor='#6699FF'>";
        ...
        for ($i = 0; $i < $nEle; $i++) {
            ...
            if($Edit[$nEle + $i]<>"-"){              # Si trae guion(-) nopongas el link
               echo "<th>$Gfont <font size='2' color='#FFFFFF'><b><a class='pg' href='".$_SERVER["PHP_SELF"]."?pagina=".$pagina."&busca=".$busca."&orden=$Ordn'>$Edit[$i]</a></th>";
            }else{
               echo "<th>$Gfont <font size='2' color='#FFFFFF'><b>$Edit[$i]</th>";
            }
        }
...
require ('config.php');
      ...
      echo "<table align='center' width='98%' border='0' cellpadding='0' cellspacing='0'><tr>";
      ...
      echo "<td width='30%' align='right'>$Gfont <b>Registros: ".number_format($numeroRegistros,"0")." &nbsp; </b> </td>";
     ...
     if($numPags <= 10 ){
        ...
        for($i=1;$i<=$numPags;$i++)    {
            ...
            if($i==$pagina){
               ...
               echo "<a class='pg' href='".$_SERVER["PHP_SELF"]."?busca=$busca&orden=$orden&pagina=$i&Vta=$Vta'>&nbsp; $i &nbsp;</a>";
		  ...
		  if($pagina >= 7){
           ...
           echo "<a href='".$_SERVER["PHP_SELF"]."?busca=$busca&orden=$orden&pagina=1&Vta=$Vta'><img src='lib/imini.gif' border='0'></a>&nbsp;";
			  ...
			  if($pagina-11>=1){
               ...
               echo " <a href='".$_SERVER["PHP_SELF"]."?busca=$busca&orden=$orden&pagina=$pg&Vta=$Vta'><img src='lib/imant.gif' border='0'></a>&nbsp; ";
        ...
        for($i=$ini;$i<=$fin;$i++)    {
            ...
            if($i==$pagina){
               ...
               echo "<a class='pg' href='".$_SERVER["PHP_SELF"]."?busca=$busca&orden=$orden&pagina=$i&Vta=$Vta'> $pag &nbsp; </a>";
		  ...
		  if($pagina+11 <= $numPags){
           ...
           $pg = $pagina + 11;
           echo " <a href='".$_SERVER["PHP_SELF"]."?busca=$busca&orden=$orden&pagina=$pg&Vta=$Vta'><img src='lib/imsig.gif' border='0'></a>&nbsp; ";

		  }

		  if($pagina < ($numPags-5)){

           echo "<a href='".$_SERVER["PHP_SELF"]."?busca=$busca&orden=$orden&pagina=$numPags&Vta=$Vta'><img src='lib/imfin.gif' border='0'></a>&nbsp;";
...
echo "$Gfont Mensaje [ <font color='FF0000'> $Msj </font> ]</font>";
