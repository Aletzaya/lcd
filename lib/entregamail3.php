...
echo "<table width='97%' border='0' cellpadding='2' cellspacing='1' bgcolor='#f1f1f1' style='border-collapse: collapse; border: 1px solid #999;'>";  
...
while ($row = mysql_fetch_array($ImgA)) {   
     ...
     $R++;     
      ...
      echo "<td align='center'>$R - <IMG SRC='estudios/$foto' border='0' width='100'></td>"; 
