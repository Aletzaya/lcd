  ...
  if($Depto<>"*"){
  		if($Subdepto<>"*"){
				 if($Suc<>"*"){
					...
					otd.recibeencaja,est.subdepto,est.depto,ot.suc,otd.obsest,ot.observaciones,otd.alterno,otd.statustom
					FROM ot,est,otd,cli
					WHERE ot.orden=otd.orden AND ot.cliente=cli.cliente AND otd.estudio=est.estudio AND est.depto='$Depto' 
					AND otd.orden>='$busca' and ot.fecha>='2016-01-01' and est.subdepto='$Subdepto' and ot.suc='$Suc'";
					...
					FROM ot,est,otd,cli
					WHERE ot.orden=otd.orden AND ot.cliente=cli.cliente AND otd.estudio=est.estudio AND est.depto='$Depto' 
					AND otd.orden>='$busca' and ot.fecha>='2016-01-01' and est.subdepto='$Subdepto'";
				 }
		}else{
			if($Suc<>"*"){
				$SqlA="SELECT cli.nombrec,ot.orden,ot.fecha,ot.hora,otd.estudio,est.descripcion,
				otd.status,otd.etiquetas,est.muestras,ot.institucion,otd.capturo,otd.recibeencaja,otd.cuatro,
				otd.recibeencaja,est.depto,ot.suc,otd.obsest,ot.observaciones,otd.alterno,otd.statustom
				FROM ot,est,otd,cli
				WHERE ot.orden=otd.orden AND ot.cliente=cli.cliente AND otd.estudio=est.estudio AND est.depto='$Depto' 
				AND otd.orden>='$busca' and ot.fecha>='2016-01-01' and ot.suc='$Suc'";
			}else{
				$SqlA="SELECT cli.nombrec,ot.orden,ot.fecha,ot.hora,otd.estudio,est.descripcion,
				otd.status,otd.etiquetas,est.muestras,ot.institucion,otd.capturo,otd.recibeencaja,otd.cuatro,
				otd.recibeencaja,est.depto,ot.suc,otd.obsest,ot.observaciones,otd.alterno,otd.statustom
				FROM ot,est,otd,cli
				WHERE ot.orden=otd.orden AND ot.cliente=cli.cliente AND otd.estudio=est.estudio AND est.depto='$Depto' 
				AND otd.orden>='$busca' and ot.fecha>='2016-01-01'";
			}
		}
  }else{
	 if($Suc<>"*"){
			...
			AND otd.orden>='$busca' and ot.fecha>='2016-01-01' and ot.suc='$Suc'";
		  	...
		  	if($Folio<>''){
				...
				otd.recibeencaja,est.depto,ot.suc,otd.obsest,ot.observaciones,otd.alterno,otd.statustom
				FROM ot,est,otd,cli
				WHERE ot.orden=otd.orden AND ot.cliente=cli.cliente AND otd.estudio=est.estudio AND otd.orden='$Folio' and ot.fecha>='2016-01-01'";
			}else{
				...
				otd.recibeencaja,est.depto,ot.suc,otd.obsest,ot.observaciones,otd.alterno,otd.statustom
				FROM ot,est,otd,cli
				WHERE ot.orden=otd.orden AND ot.cliente=cli.cliente AND otd.estudio=est.estudio AND otd.orden>='$busca' and ot.fecha>='2016-01-01'";
			}
	 }
  }
...
echo "<hr noshade style='color:000099;height:1px'>";
   ...
   echo "<form name='form1' method='post' action='estdepto.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc'>";
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=*&Subdepto=*&Suc=$Suc'><font color=$marcat><font size='1'>Todos los Deptos</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=1&Subdepto=*&Suc=$Suc'><font color=$marca1><font size='1'>Laboratorio</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=2&Subdepto=*&Suc=$Suc'><font color=$marca2><font size='1'>Rayos X y USG</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=3&Subdepto=*&Suc=$Suc'><font color=$marca3><font size='1'>Especiales</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=4&Subdepto=*&Suc=$Suc'><font color=$marca4><font size='1'>Servicios</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=6&Subdepto=*&Suc=$Suc'><font color=$marca6><font size='1'>Externos</b></a></td>";
   ...
   echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=*&Subdepto=*&Suc=$Suc'><font color=$marcat><font size='1'>Todos Subdeptos</b></a></td>";
      
	  while ($Subdepto=mysql_fetch_array($SubA)){
		  if ($Subdepto[subdepto]==$_REQUEST[Subdepto]){
  	   		echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=$Subdepto[departamento]&Subdepto=$Subdepto[subdepto]&Suc=$Suc'><font size='1' color='#F000000'>$Subdepto[subdepto]</font></b></a></td>";
		  }else{
	   		echo "<td>$Gfont <b> <a class='pg' href='estdepto.php?Depto=$Subdepto[departamento]&Subdepto=$Subdepto[subdepto]&Suc=$Suc'><font size='1'>$Subdepto[subdepto]</font></b></a></td>";
		  }
	  }
			$Subdepto=$_REQUEST[Subdepto];
   echo "<hr noshade style='color:000099;height:1px'>";
   ...
   if(!$res=mysql_query($SqlA." ORDER BY ".$OrdenDef,$link)){
        ...
        $res=mysql_query($sql,$link);
		  ...
		  $Suc=$_REQUEST[Suc];
    	  echo "<form name='form' method='post' action='estdepto.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc'>";
...
//          echo "<td align='center'>$Gfont<font size='1'><b>Etiq</b></td>";
          echo "<td align='center'>$Gfont<font size='1'><b>TOMA</b></td>";
          echo "<td align='center'>$Gfont<font size='1'><b>RECOLECC</b></td>";
		  echo "<td align='center'>$Gfont<font size='1'><b>PENDIEN</b></td>";
...
*/          $nRng++;
	  ...
	  echo "</table>";
      PonPaginacion2(false);      #-------------------pon los No.de paginas-------------------
	}
