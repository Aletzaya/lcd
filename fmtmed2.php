<?php
  ...
  $OrdenDef = "med.nombrec";           //Orden de la tabla por defaults
  ...
  if(substr($busca,0,1)=='-'){
     ...
     $cSql="SELECT $Qry[campos] FROM $Qry[froms] WHERE med.medico='$busca'";
  }else{
     #Armo el query segun los campos tomados de qrys;
     $cSql="SELECT $Qry[campos],med.medico FROM $Qry[froms] WHERE $BusInt $Qry[filtro]";
     //echo $cSql;
  }   
  ...
  $aIzq   = array("Selecc","-","-");	  //Arreglo donde se meten los encabezados; Izquierdos
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href='movcmce.php?Medico=$rg[medico]&busca=NUEVO'><img src='lib/ok.png' alt='Elige este reg' border='0'></td>";
