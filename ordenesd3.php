...
//						} 
   ...
   echo "<tr bgcolor ='#618fa9'>";
	...
	if($Cambia=='No'){
		echo "<td> <form name='form1' method='post' action='ordenesd3.php?cambia=SI&busca=$busca'>$Gfont <font color='#ffffff'>Cliente: $He[cliente] $He[5] <p> &nbsp; Edad:  $anos A&ntilde;os $meses Meses &nbsp;&nbsp; F. Nac.: $He[fechan]</td>
		<td>$Gfont <font color='#ffffff'>Fech/Hra: $He[fecha]&nbsp;".substr($He[hora],0,5)."&nbsp;&nbsp;&nbsp;
		Fech/entrega: $He[fechae] &nbsp;".substr($He[horae],0,5)."&nbsp; <INPUT TYPE='SUBMIT' name='Edita' value='Edita'>
		</td><td>$Gfont <font color='#ffffff'> Pagada: $He[pagada]</td>";
	}else{
		echo "<td> <form name='form1' method='post' action='ordenesd3.php?op=cb&busca=$busca'> $Gfont <font color='#ffffff'>Cliente: $He[cliente] $He[5] <p> &nbsp; Edad:  $anos A&ntilde;os $meses Meses &nbsp;&nbsp; F. Nac.: $He[fechan]</td>
		<td>$Gfont <font color='#ffffff'>Fech/Hra: $He[fecha]&nbsp;".substr($He[hora],0,5)."&nbsp;&nbsp;&nbsp;
		Fech/entrega: <input name='Fechae' type= 'text' size='10' value='$He[fechae]'> &nbsp; <input name='Horae' type= 'text' size='8' value='$He[horae]'>
		<INPUT TYPE='SUBMIT' name='Cambia' value='Cambia'></td><td>$Gfont <font color='#ffffff'> Pagada: $He[pagada]</td>";
		echo "</form>";
	}
