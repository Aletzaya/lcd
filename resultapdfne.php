...
require_once('tcpdf2/barcodes.php');
...
class MYPDF extends TCPDF {
    ...
    //Page header
    function Header() {
    	global $nombrecli,$anos,$meses,$sexo,$nombremed,$institucion,$Orden,$FechaLet,$Nombrestud,$Estudio,$dias,$Usr;
        // Logo
        $image_file2 = 'lib/logon.png';
        ...
        $this->writeHTML('<table width="100"><tr><td width="130">&nbsp;</td><td width="700">&nbsp;</td></tr></table>', false, 0);

        $this->writeHTML('<table width="100"><tr><td width="130">&nbsp;</td><td width="700">'.$institucion.' - '.$Orden.' &nbsp;&nbsp; '.$nombrecli.' &nbsp;&nbsp; '.$edad.' &nbsp;'.$link.'</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="130">&nbsp;</td><td width="700">Sexo: '.$sexo.' &nbsp;&nbsp;&nbsp;  Fecha: '.$FechaLet.'</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="130">&nbsp;</td><td width="700">Médico: '.$nombremed.'</td></tr></table>', false, 0);
      ...
      //  $this->writeHTML('<table width="100"><tr><td width="450">'.write1DBarcode('O='.$Orden.'&E='.$Estudio, 'C128A', '', '', '', 7, 0.3, $style, 'N').'</td><td width="700">&nbsp;</td></tr></table>', false, 0);


        $this->write1DBarcode('O='.$Orden.'-E='.$Estudio, 'C128A', '', '', '', 7, 0.3, $style, 'N');

        $this->writeHTML('<br><br><br><br><br>', false, 0);
    ...
    function Footer() {
        ...
        $image_file = 'lib/logo50.png';

        $this->Image($image_file, 8, 249, 32, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);

        // Position at 15 mm from bottom
        $this->SetFont('helvetica', 'B', 10);

        $this->writeHTML('<table width="100"><tr><td width="50">&nbsp;</td><td width="1000">Laboratorio Clinico Duran S.A. de C.V.</td></tr></table>', false, 0);

        $this->SetFont('helvetica', '', 4);

        $this->writeHTML('<table width="100"><tr><td width="50">&nbsp;</td><td width="700">&nbsp;</td></tr></table>', false, 0);

        $this->SetFont('helvetica', '', 9);

        $this->writeHTML('<table width="100"><tr><td width="50">&nbsp;</td><td width="1000">Fray Pedro de Gante No. 108, Col. Centro, Texcoco CP 56100, Estado de México - ( Frente a la Catedral )</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="50">&nbsp;</td><td width="1100"><img src="images/telefono.png" width="18" height="18" /> &nbsp; 800 711 9094    59 59 54 11 40    <img src="lib/email.png" width="16" height="14" />  atencionaclientes@dulab.com.mx </td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="50">&nbsp;</td><td width="1100"> <img src="images/internet.png" width="18" height="18" /> &nbsp; www.dulab.com.mx  <img src="images/facebook1.png" width="18" height="18" />  www.facebook.com/Laboratorioclinicoduran/ </td></tr></table>', false, 0);
    }
}
