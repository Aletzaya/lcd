    ...
    function Header() {
		...
		**********/
        $image_file = 'lib/RESULTADOS_MC1-03.png';
  		$this->Image($image_file, 18, 8, 180, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
...
function Footer() {
  ...
  $this->Image($image_file, 15, 80, 150, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
  $image_file = 'lib/RESULTADOS_MC3-03.png';
  $this->Image($image_file, 45, 80, 150, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
 // $image_file = 'lib/firma_jess.jpg';
   // $this->Image($image_file, 88, 145, 35, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);      
}
}
...
if($Personal[cedula]<>''){
	...
	$html ='<br><table width="1000" border="0" cellspacing="0" cellpadding="0"><tr><td width="350"></td><td width="400" align="center"><b> A T E N T A M E N T E </b></td></tr><tr><td width="350"></td><td width="400" align="center"><img src="Firma2.jpg" alt="test alt attribute" width="250" height="100" border="0" /></td></tr><tr><td width="350"></td><td width="400" align="center">'.$Personal1[profesion].' '.utf8_encode($Personal1[nombre]).'</td></tr><tr><td width="350"></td><td width="400" align="center">Cedula Profesional '.$Personal1[cedula].'</td></tr></table>';
}	
