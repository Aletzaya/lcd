...
}if (cCampo=='Munconsultorio'){document.form1.Munconsultorio.value=document.form1.Munconsultorio.value.toUpperCase();
}if (cCampo=='Munparticular'){document.form1.Munparticular.value=document.form1.Munparticular.value.toUpperCase();
  ...
  <td>
   <form name="form1" method="get" action="medicose.php" onSubmit="return Completo();" >
        ...
        <p>Dir.part. 
          ...
          Col.: 
          <input name="Locparticular" type="text" size="15" value ='<?php echo $Cpo[locparticular]; ?>' onBlur="Mayusculas('Locparticular')">
          Mpio 
          <input type="text" name="Munparticular" value ='<?php echo $Cpo[munparticular]; ?>' onBlur="Mayusculas('Munparticular')">
          Tel. 
        ...
        <p>Dir.cons 
          ...
          Col.: 
          <input name="Locconsultorio" type="text" size="15" value ='<?php echo $Cpo[locconsultorio]; ?>' onBlur="Mayusculas('Locconsultorio')">
          Mpio 
          <input type="text" name="Munconsultorio" value ='<?php echo $Cpo[munconsultorio]; ?>' onBlur="Mayusculas('Munconsultorio')">
          Tel. 
