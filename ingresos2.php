<?php
  ...
  if(substr($busca,0,1)=='-'){
     ...
     $cSql  = "SELECT $Qry[campos],ot.institucion FROM $Qry[froms],ot WHERE $cQry cja.orden='$busca' and cja.orden=ot.orden";
  
     
  }else{

      #Armo el query segun los campos tomados de qrys;
     $cSql="SELECT $Qry[campos],ot.institucion FROM $Qry[froms],ot WHERE $cQry $BusInt $Qry[filtro] and cja.orden=ot.orden";
  ...
  $aIzq   = array("Recibo","-","-");	  //Arreglo donde se meten los encabezados; Izquierdos
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href=impot.php?busca=$rg[orden]&pagina=$pagina&reimp=1><img src='lib/print.png' alt='Edita registro' border='0'></a></td>";
