<?php
  ...
  if(substr($busca,0,1)=='-'){
     ...
     $cSql  = "SELECT $Qry[campos] FROM $Qry[froms] WHERE dep.nombre='$busca'";
  }else{
  ...
  $aIzq   = array("Edita","-","-","Detalle","-","-");	  //Arreglo donde se meten los encabezados; Izquierdos
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href='$cLink?busca=$rg[departamento]'><img src='lib/edit.png' alt='Modifica Registro' border='0'></td>";
           echo "<td align='center'><a href='$cLinkd?busca=$rg[departamento]'><img src='lib/browse.png' alt='Detalle' border='0'></td>";
