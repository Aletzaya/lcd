<?php
  ...
  $HeA = mysql_query("SELECT el.id,el.fecha,el.hora,el.concepto,el.cantidad,el.importe,el.depto
         FROM el
         WHERE el.id = '$busca'");
...
<?php
  ...
  echo "<tr>";
  echo "<td>$Gfont <b> No.Entrada: $He[id]</b></td>";
  ...
  echo "<tr>";
  echo "<td>$Gfont Recibio: $He[depto] &nbsp; &nbsp; </td>";
  ...
  echo "<div align='center'>$He[depto]</div>";
  ...
  echo "<form name='form1' method='post' action='impentlab.php?busca=$busca'>";
