...
//						} 
   ...
   echo "<tr bgcolor ='#618fa9'>";
	...
	if($opm=='abrir'){  
		...
		echo "<td width='3%' align='center' bgcolor ='#FFFFFF'><a class='vt' href='ordenesdet2.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opm=cerrar'>$alerta</a></td>";
		...
		echo "<td width='3%' align='center' bgcolor ='#FFFFFF'><a class='vt' href='ordenesdet2.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opm=abrir'>$alerta</a></td>";
...
echo "<tr><td>";
echo " &nbsp; <a class='pg' href='ordenespro.php?Suc=$Suc&pagina=$pagina&NC=$NC'><img src='lib/regresa.jpg' border=0></a> ";
echo "</td><td>";
