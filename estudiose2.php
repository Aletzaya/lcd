<?php
  ...
  if($op=='Agrega'){
        ...
        if($busca=='NUEVO'){
          ...
          if($Exi[estudio]==$_REQUEST[Estudio]){
            ...
            header("Location: estudiose2.php?Msj=$Msj&pagina=$pagina");
              ...
              $lUp = mysql_query("INSERT into $Tabla (estudio,descripcion,subdepto,depto,clavealt,agrego,fechalta,base,consentimiento,costo,comision)
              VALUES
              ('$_REQUEST[Estudio]','$_REQUEST[Descripcion]','$_REQUEST[Subdepto]','$Dep[0]','$_REQUEST[Clavealt]','$Usr','$fechmod','$_REQUEST[Base]','$_REQUEST[Consentimiento]','$_REQUEST[Costo]','$_REQUEST[Comision]')");
          ...
          $lUp = mysql_query("UPDATE $Tabla SET descripcion='$_REQUEST[Descripcion]',clavealt='$_REQUEST[Clavealt]',subdepto='$_REQUEST[Subdepto]',depto='$Dep[0]',activo='$_REQUEST[Activo]',modify='$Usr',fechmod='$fechmod',base='$_REQUEST[Base]',consentimiento='$_REQUEST[Consentimiento]',costo='$_REQUEST[Costo]',comision='$_REQUEST[Comision]' WHERE estudio='$busca' limit 1");
    ...
    if($Producto <> '' AND $_REQUEST[Cantidad] > 0 ){
     ...
     $Producto  = "";
          ...
          $lUp = mysql_query("UPDATE $Tabla SET objetivo='$_REQUEST[Objetivo]',condiciones='$_REQUEST[Condiciones]',contenido='$_REQUEST[Contenido]',significadocli='$_REQUEST[Significadocli]',observaciones='$_REQUEST[Observaciones]',respradiologia='$_REQUEST[Respradiologia]',modify='$Usr',fechmod='$fechmod' WHERE estudio='$busca' limit 1");
    ...
    if (!mysql_query($cSql)) {
        ...
        die('<div align="center"><p>&nbsp;</p>Error critico[paso 1]<br>el proceso <b>NO</b> se finaliz&oacute; correctamente, favor de informar al <b>departamento de sistemas</b><br><b> ' . $Archivo . ' ' . mysql_error() . '</b><br> favor de dar click en la flecha <a href=menu.php?op=102><img src=lib/regresa.jpg border=0></a> para regresar</div>');
          ...
          $lUp = mysql_query("UPDATE $Tabla SET proceso='$_REQUEST[Proceso]',tiempoestd='$_REQUEST[Tiempoestd]',tiempoesth='$_REQUEST[Tiempoesth]',entord='$_REQUEST[Entord]',entordh='$_REQUEST[Entordh]',enthosd='$_REQUEST[Enthosd]',enthos='$_REQUEST[Enthos]',enturgd='$_REQUEST[Enturgd]',enturg='$_REQUEST[Enturg]',modify='$Usr',fechmod='$fechmod',dobleinterpreta='$_REQUEST[Dobleinterpreta]',producto_entregar='$_REQUEST[Producto_entregar]',indmuestras='$_REQUEST[indmuestras]' WHERE estudio='$busca' limit 1");
  ...
  $cSql = "SELECT estudio,descripcion,objetivo,condiciones,tubocantidad,tiempoest,entord,entexp,enthos,enturg,
    equipo,muestras,estpropio,subdepto,contenido,comision,observaciones,proceso,clavealt,significadocli,respradiologia,activo,dobleinterpreta,modify,fechmod,agrego,fechalta,depto,base,ventajas,promogral,tiempoestd,tiempoesth,entordh,enthosd,enturgd,bloqbas,bloqeqp,bloqmue,bloqcon,bloqdes,bloqadm,bloqatn,msjadmvo,consentimiento,producto_entregar,costo,indmuestras
...
if($opm=='basicos'){
      ...
      if($busca=='NUEVO' and $op='Depto'){
            ...
            echo "<tr><td align='right'>$Gfont Estudio $Gfon</td><td align='left'><input type='text' name='Estudio' value='$_REQUEST[Estudio]' maxlength='9' onBlur=Mayusculas('Estudio') size='9'></td>";
            ...
            echo "<tr><td align='right'>$Gfont Comision: </td><td align='left'><input type='text' name='Comision' value='$Cpo[comision]' size='3'></td></tr>";


      }else{

          echo "<tr><td align='right'>$Gfont Estudio $Gfon</td><td align='left'><input type='text' name='Estudio' value='$Cpo[0]' maxlength='9' onBlur=Mayusculas('Estudio') size='9'></td>";
...
//              }
      ...
      echo "<tr border='1'>
      <td align='center' bgcolor=$colorm1><a href='estudiose2.php?ele=1&busca=$busca&opm=elementos&pagina=$_REQUEST[pagina]'>$Gfont Elementos PDF Standard &nbsp;</font></a></td>
      ...
      <td align='center' bgcolor=$colorm3><a href='estudiose2.php?ele=3&busca=$busca&opm=elementos&pagina=$_REQUEST[pagina]'>$Gfont Elementos PDF-Alternativo 2 &nbsp;</font></a></td>
      <td align='center' bgcolor=$colorm4><a href='estudiose2.php?ele=4&busca=$busca&opm=elementos&pagina=$_REQUEST[pagina]'>$Gfont Elementos PDF-Alternativo 3 &nbsp;</font></a></td></tr>";
 ...
 //echo $cSqlpdf;
      ...
      echo "<td align='left'>$Gfont Hrs. $Gfon <input name='Tiempoesth' type='text' size='6' value=$Cpo[tiempoesth]></td></tr>";
      ...
      echo "<td align='left'>$Gfont Hrs. $Gfon <input name='Enthos' type='text' size='6' value=$Cpo[enthos]></td></tr>";
...
*/
        ...
        echo "<td align='left'>$Gfont Muestras $Gfon";

        echo "<SELECT name='indmuestras'>";
        echo "<option value='Unica'>Unica</option>";
        echo "<option value='Varias'>Varias</option>";
        echo "<option SELECTed value='$Cpo[indmuestras]'>$Cpo[indmuestras]</option>";
        echo "</SELECT>";
        echo "</td>";
        echo "</tr><br/>";
      ...
      echo "<tr><td>$Gfont Significado Clinico $Gfon</td><td><TEXTAREA NAME='Significadocli' cols='110' rows='5' >$Cpo[significadocli]</TEXTAREA></td></tr>";
