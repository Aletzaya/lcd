<?php
  ...
  if($op=='Agrega'){
    ...
    ('$Fecha','$Usr','$_REQUEST[busca]','Elimina Sinonimo $_REQUEST[Sinonimo]')");
     ...
     $lUp    = mysql_query("delete FROM estd WHERE estudio='$busca' and producto='$_REQUEST[producto]'",$link);
     ...
     $lUp    = mysql_query("delete FROM conest WHERE estudio='$busca' and id='$_REQUEST[id]'",$link);
        ...
        if($busca=='NUEVO'){
          ...
          if($Exi[estudio]==$_REQUEST[Estudio]){
            ...
            header("Location: estudiose3.php?Msj=$Msj&pagina=$pagina");

          }else{

              $lUp = mysql_query("INSERT into $Tabla (estudio,descripcion,subdepto,depto,clavealt,agrego,fechalta,base,consentimiento)
              VALUES
              ('$_REQUEST[Estudio]','$_REQUEST[Descripcion]','$_REQUEST[Subdepto]','$Dep[0]','$_REQUEST[Clavealt]','$Usr','$fechmod','$_REQUEST[Base]','$_REQUEST[Consentimiento]')");
              ...
              header("Location: estudiose3.php?busca=$_REQUEST[Estudio]&pagina=$pagina");
          }

        }else{

          $lUp = mysql_query("UPDATE $Tabla SET descripcion='$_REQUEST[Descripcion]',clavealt='$_REQUEST[Clavealt]',subdepto='$_REQUEST[Subdepto]',depto='$Dep[0]',activo='$_REQUEST[Activo]',modify='$Usr',fechmod='$fechmod',base='$_REQUEST[Base]',consentimiento='$_REQUEST[Consentimiento]' WHERE estudio='$busca' limit 1");
  ...
  $cSql = "SELECT estudio,descripcion,objetivo,condiciones,tubocantidad,tiempoest,entord,entexp,enthos,enturg,
    equipo,muestras,estpropio,subdepto,contenido,comision,observaciones,proceso,clavealt,respradiologia,activo,dobleinterpreta,modify,fechmod,agrego,fechalta,depto,base,clavealt,ventajas,promogral,tiempoestd,tiempoesth,entordh,enthosd,enturgd,bloqbas,bloqeqp,bloqmue,bloqcon,bloqdes,bloqadm,bloqatn,msjadmvo,consentimiento,producto_entregar
...
<td align="center">
<ul id='button'>
<li><?php echo "<a href=estudiose3.php?opm=basicos&busca=$_REQUEST[busca]>Datos Basicos</a>"; ?></li>  
</ul>
</td>
</tr>
</table>
...
<?php if($opm=='basicos'){?>
  <li><?php echo "<a href=estudiose3.php?opm=basicos&busca=$_REQUEST[busca] class=current>Datos Basicos</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=basicos&busca=$_REQUEST[busca]>Datos Basicos</a>"; ?></li>
<?php }?>

<?php if($opm=='equipos'){?>
  <li><?php echo "<a href=estudiose3.php?opm=equipos&busca=$_REQUEST[busca] class=current>Equipos por Unidad</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=equipos&busca=$_REQUEST[busca]>Equipos por Unidad</a>"; ?></li>
<?php }?>

<?php if($opm=='muestras'){?>
    <li><?php echo "<a href=estudiose3.php?opm=muestras&busca=$_REQUEST[busca] class=current>Muestras</a>"; ?></li>
<?php }else{?>
    <li><?php echo "<a href=estudiose3.php?opm=muestras&busca=$_REQUEST[busca]>Muestras</a>"; ?></li>
<?php }?>

<?php if($opm=='contenido'){?>
  <li><?php echo "<a href=estudiose3.php?opm=contenido&busca=$_REQUEST[busca] class=current>Contenido</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=contenido&busca=$_REQUEST[busca]>Contenido</a>"; ?></li>
<?php }?>

<?php if($opm=='general'){?>
  <li><?php echo "<a href=estudiose3.php?opm=general&busca=$_REQUEST[busca] class=current>Descripcion general</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=general&busca=$_REQUEST[busca]>Descripcion general</a>"; ?></li>
<?php }?>

<?php if($opm=='admin'){?>
  <li><?php echo "<a href=estudiose3.php?opm=admin&busca=$_REQUEST[busca] class=current>Administracion</a>"; ?></li>
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=admin&busca=$_REQUEST[busca]>Administracion</a>"; ?></li>
<?php }?>

<?php if($opm=='promocion'){?>
  <li><?php echo "<a href=estudiose3.php?opm=promocion&busca=$_REQUEST[busca] class=current>Atn clientes/Promocion</a>"; ?></li>   
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=promocion&busca=$_REQUEST[busca]>Atn clientes/Promocion</a>"; ?></li>   
<?php }?>

<?php if($opm=='elementos'){?>
  <li><?php echo "<a href=estudiose3.php?opm=elementos&busca=$_REQUEST[busca] class=current>Elementos de Cap./Imp.</a>"; ?></li>   
<?php }else{?>
  <li><?php echo "<a href=estudiose3.php?opm=elementos&busca=$_REQUEST[busca]>Elementos de Cap./Imp.</a>"; ?></li>   
<?php }?>
...
if($opm=='basicos'){
      ...
      echo "<form name='form1' method='get' action='estudiose3.php'>";
      ...
      if($busca=='NUEVO' and $op='Depto'){
            ...
            echo "<td align='right'>$Gfont Clave alterna </td><td align='left'><input type='text' name='Clavealt' value='$_REQUEST[Clavealt]' maxlength='20' onBlur=Mayusculas('Clavealt') size='20'></td></tr>";
          ...
          echo "<td align='right'>$Gfont Clave alterna </td><td align='left'><input type='text' name='Clavealt' value='$Cpo[clavealt]' maxlength='20' onBlur=Mayusculas('Clavealt') size='20'></td></tr>";
          ...
          echo "<td align='left'><input name='Sinonimo' type='text' id='Sinonimo' onBlur=Mayusculas(Sinonimo) size='40'><input type='submit' name='op' value='Agrega'>";
              ...
              while ($row=mysql_fetch_array($result)){
                    ...
                    if($Cpo[bloqbas]=='No'){
                         ...
                         echo "<td align='center'><a href='estudiose3.php?busca=$busca&Sinonimo=$row[0]&pagina=$pagina&op=El&opm=basicos'><img src='lib/deleon.png' alt='Edita reg' border='0'></a></td></tr>";
      ...
      if($Cpo[bloqbas]=='No' or $busca=='NUEVO'){
          ...
          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=basicos&op=cerrarbas&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='Guardar'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=basicos&op=abrirbas&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
...
/***   Proceso y clasificacion   ***/
      ...
      echo "<tr border='1'><td align='center' bgcolor=$colorm1><a href='estudiose3.php?suc=1&busca=$busca&opm=equipos'>$Gfont LCD-TX &nbsp;</font></a></td>
    <td align='center' bgcolor=$colorm2><a href='estudiose3.php?suc=2&busca=$busca&opm=equipos'>$Gfont LCD-TPX &nbsp;</font></a></td>
    <td align='center' bgcolor=$colorm3><a href='estudiose3.php?suc=3&busca=$busca&opm=equipos'>$Gfont LCD-HF &nbsp;</font></a></td>
    <td align='center' bgcolor=$colorm4><a href='estudiose3.php?suc=4&busca=$busca&opm=equipos'>$Gfont LCD-LR &nbsp;</font></a></td></tr>";
     ...
     echo "<tr><td align='right' colspan='2'>$Gfont Equipo: </td><td>";
     ...
     echo "<tr><td align='right' colspan='2'>$Gfont Tecnica: </td><td>";
      ...
      echo "<tr><td align='right' colspan='2'>$Gfont Externo 1: </td><td>";
      ...
      echo "<tr><td align='right' colspan='2'>$Gfont Externo 2: </td><td>";
      ...
      echo "<tr><td align='right' colspan='2'>$Gfont Externo 3: </td><td>";
      ...
      echo "<tr><td align='right' colspan='2'>$Gfont Mixto: </td>";
      echo "<td>$Gfont<input type='checkbox' value='1' name='Mixtolcd' $Mixtolcdcheck> LCD-TX </font>";
      ...
      if($Cpo[bloqeqp]=='No'){
          ...
          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=equipos&op=cerrareqp&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='Actualiza'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=equipos&op=abrireqp&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }

      echo "<input type='hidden' name='opm' value='equipos'>";
      echo "<input type='hidden' name='busca' value='$_REQUEST[busca]'>";

      echo " &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href=javascript:wingral('logmodest.php?busca=$busca&opm=equipos')><font size='1'> *** Modificaciones ***</a>  </td></tr>";
      ...
      echo "<tr border='1'><td align='center' bgcolor=$colorm1><a href='estudiose3.php?ele=1&busca=$busca&opm=elementos'>$Gfont Elementos PDF Standard &nbsp;</font></a></td>
      <td align='center' bgcolor=$colorm2><a href='estudiose3.php?ele=2&busca=$busca&opm=elementos'>$Gfont Elementos PDF-Alternativo &nbsp;</font></a></td>
      <td align='center' bgcolor=$colorm3><a href='estudiose3.php?ele=3&busca=$busca&opm=elementos'>$Gfont Elementos PDF-Alternativo 2 &nbsp;</font></a></td></tr>";
     ...
     filtro($Tablapdf);           #---------------Si trae algo del filtro realizalo ----------------
      ...
      if(!$res=mysql_query($cSqlpdf.$cWhe,$link)){
          ...
          while($registro=mysql_fetch_array($res)){
              ...
              echo "<tr bgcolor='$Fdo' onMouseOver=this.style.backgroundColor='$Gbarra';this.style.cursor='hand' onMouseOut=this.style.backgroundColor='$Fdo';>";
              echo "<td align='center'><a href=estudiose3.php?ele=$ele&busca=$busca&opm=elementos&cEd=$registro[idnvo]&pagina=$pagina><img src='lib/edit.png' alt='Edita reg' border='0'></td>";            
              ...
              if($bloqueado=='No'){
                echo "<td align='center'><a href=estudiose3.php?ele=$ele&busca=$busca&opm=elementos&cId=$registro[id]&op=Si&pagina=$pagina><img src='lib/deleon.png' alt='Borra reg' border='0'></td>";
              }else{
          ...
          if($bloqueado=='No'){
              ...
              echo " &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href=estudiose3.php?ele=$ele&busca=$busca&opm=elementos&op=cerrar&pagina=$pagina>Cerrar <img src='images/candadoa.png' alt='pdf' border='0'></a><font size='2'> Ultima Modificacion por: $usr - $fecha </font>";

          }else{

              echo " &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href=estudiose3.php?ele=$ele&busca=$busca&opm=elementos&op=abrir&pagina=$pagina>Abrir <img src='images/candadoc.png' alt='pdf' border='0'></a><font size='2'> Ultima Modificacion por: $usr - $fecha </font>";
          }
      ...
      if( ($nRng % 2) > 0 ){$Fdo='FFFFFF';}else{$Fdo=$Gfdogrid;}    //El resto de la division;
        ...
        if($Cpo[bloqmue]=='No'){
          echo "<td align='center'><a href='estudiose3.php?busca=$busca&id=$row3[id]&proceso=$row3[proceso]&op=Elimproceso&opm=muestras'><img src='lib/deleon.png' alt='Edita reg' border='0'></a></tr>";
        }else{
          echo "<td align='center'>-</td></tr>";
        }
      ...
      echo "<td align='left'>$Gfont Cant $Gfon <input class='Input' type='text' name='Cantidad' size='4' value=''><INPUT TYPE='SUBMIT' name='op' value='Registrar'></td><td align='left' colspan='2'>";
        ...
        if( ($nRng % 2) > 0 ){$Fdo='FFFFFF';}else{$Fdo=$Gfdogrid;}    //El resto de la division;
          ...
          if($Cpo[bloqmue]=='No'){
            echo "<td align='center'><a href='estudiose3.php?busca=$busca&producto=$row2[producto]&op=Elim&opm=muestras'><img src='lib/deleon.png' alt='Edita reg' border='0'></a></tr>";
          }else{
            echo "<td align='center'>-</td></tr>";
          }
      ...
      if($Cpo[bloqmue]=='No'){
          ...
          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=muestras&op=cerrarmue&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='Guarda'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=muestras&op=abrirmue&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
      ...
      if($Cpo[bloqdes]=='No'){
          ...
          echo "<tr><td align='center' colspan='6'><a href=estudiose3.php?busca=$busca&opm=general&op=cerrardes&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='Acepta'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=general&op=abrirdes&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
    ...
    ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=1",$link);
                while ($row=mysql_fetch_array($result)){
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=2",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=3",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=4",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=5",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=6",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=7",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=8",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=9",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=10",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=11",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=12",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=13",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=14",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=15",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=16",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=17",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=18",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=19",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=20",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=21",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=22",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
        ...
        <div>
            <?php
                $result=mysql_query("select institucion,alias from inst where lista=23",$link);
                while ($row=mysql_fetch_array($result)){
                      echo "$Gfont  &diams;  $row[institucion] $row[alias] &nbsp; </font> ";
                }
            ?>
    ...
    <?php
      ...
      if($Cpo[bloqadm]=='No'){
          ...
          echo "<tr><td align='center' colspan='6'><a href=estudiose3.php?busca=$busca&opm=admin&op=cerraradm&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='GuardaPrec'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='6'><a href=estudiose3.php?busca=$busca&opm=admin&op=abriradm&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
      ...
      if($Cpo[bloqatn]=='No'){
          ...
          echo "<tr><td align='center' colspan='6'><a href=estudiose3.php?busca=$busca&opm=promocion&op=cerraratn&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp; <input type='submit' name='op' value='GuardaPromo'>&nbsp; &nbsp; ";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=promocion&op=abriratn&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
     ...
     if($Cpo[bloqcon]=='No'){
          ...
          echo "<a href='agrestcont.php?pagina=0&Sort=Asc&estudio=$busca'><img src='lib/lupa_o.gif' alt='Catalogo' border='0' width='20' height='20'></a></td>";
        ...
        if( ($nRng % 2) > 0 ){$Fdo='FFFFFF';}else{$Fdo=$Gfdogrid;}    //El resto de la division;
          ...
          echo "<td bgcolor='#FFFFFF'></td><td align='left'>$Gfont $row3[conest]  -  $row3[descripcion]</td>";
               if($Cpo[bloqcon]=='No'){
                ...
                echo "<td align='center'><a href='estudiose3.php?busca=$busca&id=$row3[id]&op=Eliest&opm=contenido'><img src='lib/deleon.png' alt='Edita reg' border='0'></a></tr>";
              }
      ...
      if($Cpo[bloqcon]=='No'){
          ...
          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=contenido&op=cerrarcon&pagina=$pagina><font size='2'> Cerrar </font><img src='images/candadoa.png' alt='pdf' border='0'></a> &nbsp;  &nbsp;  &nbsp;";

      }else{

          echo "<tr><td align='center' colspan='4'><a href=estudiose3.php?busca=$busca&opm=contenido&op=abrircon&pagina=$pagina><font size='2'> Abrir </font><img src='images/candadoc.png' alt='pdf' border='0'></a>";
      }
