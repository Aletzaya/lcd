<?php
  ...
  if($op=='Si'){                    //Elimina Registro
     $lUp=mysql_query("delete from hr where id='$_REQUEST[cId]' limit 1",$link);
  ...
  $Edit = array("Edit","Detalle","Horario","Descripcion","Elim","","","Nid","Ddescripcion","-");
...
<?php headymenu($Titulo,1);
  ...
  if(!$res=mysql_query($cSql.$cWhe,$link)){
      ...
      while($registro=mysql_fetch_array($GLOBALS[res])){
           ...
           echo "<td align='center'><a href='horariose.php?busca=$registro[id]&pagina=$pagina'><img src='lib/edit.png' alt='Modifica Registro' border='0'></td>";
           echo "<td align='center'><a href='horariosd.php?busca=$registro[id]&pagina=$pagina'><img src='lib/browse.png' alt='Elimina Registro' border='0'></td>";
           echo "<td align='left'>$Gfont &nbsp; $registro[id] &nbsp;</font></a></td>";
           echo "<td align='left'>$Gfont $registro[descripcion]</font></td>";
           echo "<td align='center'><a href='horarios.php?cId=$registro[id]&op=El&pagina=$pagina'><img src='lib/deleon.png' alt='Elimina Registro' border='0'></td>";
           echo "</tr>";
           $nRng++;
      }
   }
