...
*/
  ...
  if( $busca == ''){
     $cSql="SELECT $Qry[campos],ot.ubicacion,ot.encaja,ot.status,ot.pagada,ot.entemailpac,ot.entemailmed,ot.entemailinst,ot.hora,ot.horae,ot.recepcionista,cli.numveces,cli.cliente,ot.importe,ot.servicio,ot.idprocedencia
...
*/
    ...
    echo "</tr>";              
      ...
      while($rg=mysql_fetch_array($res)){
          ...
          echo "<td align='center'><a href=ordenesd.php?busca=$rg[orden]&pagina=$pagina&Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc><img src='lib/browse.png' alt='Detalle' border='0'></a></td>";
