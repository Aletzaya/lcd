<?php
  ...
  if($_REQUEST[Boton] == Agregar){
	  ...
	  $lUp   = mysql_query("INSERT INTO ele (estudio,descripcion,tipo,longitud,decimales,id,min,max) 
	   		  VALUES 
  	  ...
  	  $lUp   = mysql_query("UPDATE ele SET descripcion='$_REQUEST[Descripcion]',tipo='$_REQUEST[Tipo]',
