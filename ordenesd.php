<?php
  ...
  if(!isset($_REQUEST[cambiar])){$Cambiar='No';}
  ...
  if($_REQUEST[opre] == 'cb'){        //Para agregar uno nuevo
		$lUp    = mysql_query("UPDATE ot set responsableco = '$_REQUEST[Responsableco]' WHERE orden='$busca'");
		$Cambiar='No';
 	    $lUp2  = mysql_query("INSERT INTO logs (fecha,usr,concepto) VALUES
		('$Fechaest','$Usr','Modifica responsable economico Ot: $busca')");
  }
	$opc     = $_REQUEST[opc];
  ...
  $cSqlH     = "SELECT ot.orden,ot.fecha,ot.hora,ot.fechae,ot.cliente,cli.nombrec,ot.importe,ot.ubicacion,ot.institucion,ot.medico,med.nombrec,ot.status,ot.recibio,ot.institucion,ot.pagada,ot.observaciones,ot.horae,cli.fechan,ot.suc,ot.recepcionista,ot.idprocedencia,ot.responsableco
                FROM ot,cli,med
  ...
  $cSqlD     = "SELECT otd.estudio,otd.status,est.descripcion,otd.precio,otd.descuento,est.muestras,otd.etiquetas,
				...
				otd.obsest,otd.usrest,otd.fechaest,otd.etiquetas,otd.alterno,otd.creapdf,est.subdepto,est.indmuestras,otd.nmuestras
                FROM otd,est
  ...
  if($_REQUEST[op]=='El'){
	if($Usr=='nazario' or $Usr=='Javier' or $Usr=='Julio'){
   ...
   echo "<tr bgcolor ='#618fa9'>";
	...
	if($opm=='abrir'){ 
		...
		if($He[idprocedencia]=='ambu'){
			...
			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc= &opm=cerrar'><img src='images/all.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";


		}else{

			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=ambu&opm=cerrar'><img src='images/ambu.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";

		}
 
		if($He[idprocedencia]=='silla'){

			echo " <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc= &opm=cerrar'><img src='images/all.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br></td>";

		}else{

			echo " <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=silla&opm=cerrar'><img src='images/silla.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br></td>";
		...
		if($He[idprocedencia]=='terceraedad'){
			...
			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=terceraedad&opm=cerrar'><img src='images/terceraedad.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";

		}

		if($He[idprocedencia]=='problemasv'){

			echo " <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc= &opm=cerrar'><img src='images/all.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> ";


		}else{

			echo " <a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=problemasv&opm=cerrar'><img src='images/problemasv.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> ";
		...
		echo "<td width='3%' align='center' bgcolor ='#FFFFFF'><a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opm=cerrar'>$alerta</a></td>";

	}else{

		echo "<td width='3%' align='center' bgcolor ='#FFFFFF'><a class='vt' href='ordenesd.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opm=abrir'>$alerta</a></td>";
...
*/
	...
	if($Cambia=='No'){
		echo "<form name='form5' method='post' action='ordenesd.php?cambia=SI&busca=$busca'><td>$Gfont <font color='#ffffff'>Fech/Hra: $He[fecha]&nbsp;".substr($He[hora],0,5)."&nbsp;&nbsp;&nbsp;
		Fech/entga: $He[fechae] &nbsp;".substr($He[horae],0,5)."&nbsp; <INPUT TYPE='SUBMIT' name='Edita' value='Edita'>
		</td>";
		echo "</form>";
		...
		echo "<form name='form5' method='post' action='ordenesd.php?op=cb&busca=$busca'><td>$Gfont <font color='#ffffff'>Fech/Hra: $He[fecha]&nbsp;".substr($He[hora],0,5)."&nbsp;&nbsp;&nbsp;
		Fech/entga: <input name='Fechae' type= 'text' size='10' value='$He[fechae]'> &nbsp; <input name='Horae' type= 'text' size='8' value='$He[horae]'>
		<INPUT TYPE='SUBMIT' name='Cambia' value='Cambia'></td>";
		echo "</form>";

	}

	echo "<td>$Gfont <font color='#ffffff'> Pagada: $He[pagada]";
		 if($Usr=='nazario' or $Usr=='Javier' or $Usr=='Julio'){
			 echo "&nbsp; [<a class='pg' href='ingreso3.php?busca=$busca&pagina=$pagina'><b>*INGRESOS</b></a>]";
		 }
	//echo "<p>&nbsp; Resp.Eco: $He[responsableco]</p></td>";

	if($Cambiar=='No'){
		echo "<p><form name='form5' method='post' action='ordenesd.php?cambiar=SI&busca=$busca'>$Gfont <font color='#ffffff'>Resp.Eco: $He[responsableco]&nbsp; <INPUT TYPE='SUBMIT' name='Editar' value='Editar'>
		";
		echo "</form></p></td>";

	}else{

		echo "<p><form name='form5' method='post' action='ordenesd.php?opre=cb&busca=$busca'>$Gfont <font color='#ffffff'>R.Eco: <input name='Responsableco' type= 'text' size='35' value='$He[responsableco]'> &nbsp; <INPUT TYPE='SUBMIT' name='Cambiar' value='Cambiar'>";
		echo "</form></p></td>";
...
//   echo "</tr>";
   ...
   " &nbsp; &nbsp; Capturo: $He[recepcionista]</td><td>$Gfont Saldo: ".number_format($He[importe]-$Cja[0],"2")." &nbsp; [<a class='pg' href='ingreso.php?busca=$busca&pagina=$pagina'>NVO/INGRESO</a>]</td>";
...
//      echo "<a class='pg' href=javascript:winuni('preanalitico.php?busca=$busca')>Cuestionario pre-analitico </a>";
   ...
   if(!$res=mysql_query($cSqlD." ORDER BY ".$OrdenDef)){
      ...
      $numeroRegistros=mysql_num_rows($res);
        ...
        echo "<td align='center'>$Gfont <b><a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=2&regis=1&status=TOMA/REALIZ&Suc=$He[suc]'>Tma/Rea</b></a></td>";
	              	...
	              	if($registro[statustom]=='TOMA/REALIZ'){				
		               echo "<td align='center'>$Gfont <font size='1'>$registro[nmuestras]</font><img src='lib/slc.png'></td>";
						...
						if($registro[statustom]==''){
		               		...
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]&muestras=1'>OK</b></a></td>";

						}else{
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]&muestras=1'><img src='lib/iconfalse.gif'></b></a></td>";
						}
		            }  
					...
					if($registro[statustom]=='TOMA/REALIZ'){				
		               echo "<td align='center'>$Gfont<img src='lib/slc.png'></td>";
						...
						if($registro[statustom]==''){
		               		...
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]'>OK</b></a></td>";

						}else{
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]'><img src='lib/iconfalse.gif'></b></a></td>";
						}
		            }   
...
echo "<tr><td>";
echo " &nbsp; <a class='pg' href='ordenescon.php?Suc=$Suc&Fech3=$Fech3&Fech2=$Fech2'><img src='lib/regresa.jpg' border=0></a> ";
echo "</td><td>";
echo " &nbsp; &nbsp; <a class='pg' href=javascript:Ventana('impeti2.php?op=3&busca=$busca')>Etiquetas</a>";
echo "</td><td>";

if($Usr=='nazario' or $Usr=='Javier' or $Usr=='Julio'){
	echo "<form name='form2' method='post' action='ordenesd.php?op=Ag&busca=$busca&Suc=$Suc&Fech3=$Fech3&Fech2=$Fech2'>";
