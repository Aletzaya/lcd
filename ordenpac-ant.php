  ...
  echo "<form name='form1' method='get' action=".$_SERVER['PHP_SELF']." onSubmit='return ValCampos();'>";
		...
		echo "<font size='2'><p align='center'><b>Informe de Estudios entregados al Paciente</b></p>";
         ...
         $Sql  = mysql_query("SELECT otd.estudio,est.descripcion,otd.lugar,otd.seis,otd.entregapac,otd.recibepac,otd.obsentrega
          ...
          //echo "<td align='center'>$Gfont2 Esposo (a)</td>";   
	      ...
	      //echo "<td align='center'>$Gfont2 Mamá</td>"; 
        ...
        while($rg=mysql_fetch_array($Sql)){
			...
			if($rg[recibepac]=='Paciente'){				
               echo "<td align='center'>$Gfont &nbsp; <img src='lib/slc.png'></td>";
				...
				if($rg[recibepac]==''){
               		echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenpac.php?Orden=$Orden&Estudio=$rg[estudio]&Entregapac=$Entregapac&Recibepac=Paciente&Obsentrega=$Obsentrega'>Paciente</a></td>";
				}else{
			...
			if($rg[recibepac]=='Familiar'){
               echo "<td align='center'>$Gfont &nbsp; <img src='lib/slc.png'></td>";
				...
				if($rg[recibepac]==''){
               		echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenpac.php?Orden=$Orden&Estudio=$rg[estudio]&Entregapac=$Entregapac&Recibepac=Familiar&Obsentrega=$Obsentrega'>Familiar</a></td>";
				}else{
					 echo "<td align='center'>$Gfont &nbsp; - </td>";
				}
            }   
			if($rg[recibepac]=='Clinic/Inst'){
               echo "<td align='center'>$Gfont &nbsp; <img src='lib/slc.png'></td>";
				...
				if($rg[recibepac]==''){
               		echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenpac.php?Orden=$Orden&Estudio=$rg[estudio]&Entregapac=$Entregapac&Recibepac=Clinic/Inst&Obsentrega=$Obsentrega'>Clinic/Inst</a></td>";
				}else{
					 echo "<td align='center'>$Gfont &nbsp; - </td>";
				}
            }
			if($rg[recibepac]=='Otro'){
               echo "<td align='center'>$Gfont &nbsp; <img src='lib/slc.png'></td>";
				...
				if($rg[recibepac]==''){
              		 echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenpac.php?Orden=$Orden&Estudio=$rg[estudio]&Entregapac=$Entregapac&Recibepac=Otro&Obsentrega=$Obsentrega'>Otro</a></td>";
				}else{
					 echo "<td align='center'>$Gfont &nbsp; - </td>";
				}
            }
               ...
               echo "<td align='center'>$Gfont $rg[obsentrega] &nbsp; <img src='lib/slc.png'></td>";
				...
				if($Obsentrega<>''){
					if($rg[recibepac]==''){
               		...
               		echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenpac.php?Orden=$Orden&Estudio=$rg[estudio]&Recibepac=$Recibepac2&Entregapac=$Entregapac2&Obsentrega=$Obsentrega'>$Obsentrega</a></td>";
				}else{
					 echo "<td align='center'>$Gfont $rg[obsentrega] </td>";
				}
            }
	  		//echo "<td>$Gfont $Obsentrega </td>";
