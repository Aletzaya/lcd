...
//		}
      ...
      header("Location: informesalt2/$cLnk?Orden=$Ord&Estudio=$Est");
        ...
        while($rg=mysql_fetch_array($res)){
          ...
          echo "<tr bgcolor='$Fdo' onMouseOver=this.style.backgroundColor='$Gbarra';this.style.cursor='hand' onMouseOut=this.style.backgroundColor='$Fdo';>";
   		 ...
   		 if($Depto<>2){
             ...
             echo "<td align='center'><a class='pg' href=javascript:WinRes('estdeptoimp.php?clnk=$clnk&Orden=$rg[1]&Estudio=$rg[4]&Depto=TERMINADA&op=im')><img src='lib/print.png' alt='Imprime resultados' border='0'></a></td>";
