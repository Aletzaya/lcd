...
class MYPDF extends TCPDF {
    ...
    function Header() {
        ...
        $this->writeHTML('<table width="100"><tr><td width="600">&nbsp;</td><td width="700">&nbsp;</td></tr></table>', false, 0);

        $this->writeHTML('<table width="100"><tr><td width="600">&nbsp;</td><td width="700">'.$institucion.' - '.$Orden.' &nbsp;&nbsp; '.$nombrecli.' &nbsp;&nbsp; '.$edad.' &nbsp;'.$link.'</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="600">&nbsp;</td><td width="700">Sexo: '.$sexo.' &nbsp;&nbsp;&nbsp;  Fecha: '.$FechaLet.'</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="600">&nbsp;</td><td width="700">Médico: '.$nombremed.'</td></tr></table>', false, 0);
    ...
    function Footer() {
        ...
        $this->writeHTML('<table width="100"><tr><td width="250">&nbsp;</td><td width="1000">Laboratorio Clinico Duran S.A. de C.V.</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="250">&nbsp;</td><td width="1000">Fray Pedro de Gante No. 108, Col. Centro, Texcoco CP 56100, Estado de México - ( Frente a la Catedral )</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="250">&nbsp;</td><td width="1100"><img src="images/telefono.png" width="18" height="18" /> &nbsp; 800 711 9094    59 59 54 11 40    <img src="lib/email.png" width="16" height="14" />  atencionaclientes@dulab.com.mx </td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="250">&nbsp;</td><td width="1100"> <img src="images/internet.png" width="18" height="18" /> &nbsp; www.dulab.com.mx  <img src="images/facebook1.png" width="18" height="18" />  www.facebook.com/Laboratorioclinicoduran/ </td></tr></table>', false, 0);
