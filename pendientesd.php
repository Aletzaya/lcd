<?php
  ...
  $cSqlH="select ot.orden,ot.fecha,ot.fechae,ot.cliente,cli.nombrec,ot.importe,ot.ubicacion,ot.institucion,ot.medico,med.nombrec,ot.status,ot.recibio from ot,cli,med where ot.cliente=cli.cliente and ot.medico=med.medico and ot.orden='$busca'";
...
<table width="100%" border="0">
  <tr>
    <td width="14%" height="59"><div align="left"><a href="pendientes.php"><img src="lib/logo2.jpg" width="100" height="80" border="0"></a></div></td>
    <td width="71%">
...
<?
  if($op=='sm'){
   ...
   if(!$res=mysql_query($cSqlD." ORDER BY ".$OrdenDef,$link)){
        ...
        echo "<p align='center'><font face='verdana' size='-2'><a href='pendientes.php?op=br'>";
    ...
    ?>
<p>&nbsp;</p>
<p><div align="left"><a href="pendientes.php?pagina=<? echo $pagina;?>"><img src="imagenes/SmallExit.bmp" border="0"></a></div><br>
