...
<body bgcolor="#FFFFFF">
  ...
  echo "<hr noshade style='color:000099;height:1px'>";
	echo "<form name='form' method='post' action='demandeptodet3.php'>";
 ...
 echo "<td align='center' colspan='9'>$Gfont <font size='1'><b>De: $filtro10 $_REQUEST[contador] $filtroF</b></font><input type='text' readonly='readonly' name='FechaI' size='10' value ='$FechaI'> <img src='lib/calendar.png' border='0' onclick=displayCalendar(document.forms[0].FechaI,'yyyy-mm-dd',this)>";
  ...
  echo "<br>";
//   echo "<form name='form1' method='post' action='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=$filtro9&FechaI=$FechaI&FechaF=$FechaF'>";

  echo "<nav>";
    echo "<ul class='fullnav'>";
      echo "<li><b><a href='demandeptodet3.php?filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'>Todos los Deptos </b></a></li>";
      echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=1&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca1>Laboratorio</b></a>";
        echo "<ul>";
          echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'>Todos Subdeptos</b></a></li>";
            while ($Subdepto=mysql_fetch_array($SubA)){
                      if ($Subdepto[subdepto]==$filtro9){
                          echo "<li> <b> <font size='1' color='#922b21'>$Subdepto[subdepto]</font></b></a></li>";
                      }elseif ($Subdepto[subdepto]==$filtroF){
                          echo "<li> <b> <font size='1' color='#922b21'>$Subdepto[subdepto]</font></b></a></li>";
                      }elseif ($Subdepto[subdepto]==$filtroG){
                          echo "<li> <b> <font size='1' color='#922b21'>$Subdepto[subdepto]</font></b></a></li>";
                      }else{
                        echo "<li> <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&contador=$contador&filtroF=$filtro9&filtro3=$filtro3&filtro5=$filtro5&FechaI=$FechaI&FechaF=$FechaF&filtro7=$filtro7&filtro9=$Subdepto[subdepto]&HoraI=$HoraI&HoraF=$HoraF&filtroG=$filtroG'><font size='1'>$Subdepto[subdepto]</font></b></a></li>";
                      }
              }
        echo "</ul>";
      echo "</li>";
      echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=2&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca2>Rayos X y USG</b></a>";
       echo "<ul>";
          echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'>Todos Subdeptos</b></a></li>";
            while ($Subdepto=mysql_fetch_array($SubA)){
                      if ($Subdepto[subdepto]==$filtro9){
        ...
        echo "</ul>";
      echo "</li>";
      echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=3&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca3>Especiales</b></a>";
        echo "<ul>";
          echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'>Todos Subdeptos</b></a></li>";
            while ($Subdepto=mysql_fetch_array($SubA)){
                      if ($Subdepto[subdepto]==$filtro9){
        ...
        echo "</ul>";
      echo "</li>";
      echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=4&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca4>Servicios</b></a>";
        echo "<ul>";
          echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'>Todos Subdeptos</b></a></li>";
            while ($Subdepto=mysql_fetch_array($SubA)){
                      if ($Subdepto[subdepto]==$filtro9){
        ...
        echo "</ul>";
      echo "</li>";
      echo "<li><b><a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=6&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca6>Externos</b></a>";
        echo "<ul>";
          echo "<li><b><a href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'>Todos Subdeptos</b></a></li>";
            while ($Subdepto=mysql_fetch_array($SubA)){
                      if ($Subdepto[subdepto]==$filtro9){
  ...
  echo "</nav>";
/*
   echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marcat><font size='1'>Todos los Deptos &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=1&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca1><font size='1'> Laboratorio &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=2&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca2><font size='1'> Rayos X y USG &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=3&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca3><font size='1'> Especiales &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=4&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca4><font size='1'> Servicios &nbsp;&nbsp;</b></a>";
   echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=6&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marca6><font size='1'> Externos </b></a>";
...
/*
  echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=*&FechaI=$FechaI&FechaF=$FechaF&HoraI=$HoraI&HoraF=$HoraF&contador=$contador'><font color=$marcat><font size='1'>Todos Subdeptos</b></a>";

  while ($Subdepto=mysql_fetch_array($SubA)){
      if ($Subdepto[subdepto]==$filtro9){
          echo "$Gfont <b> <font size='1' color='#922b21'>$Subdepto[subdepto]</font></b></a>";
      }elseif ($Subdepto[subdepto]==$filtroF){
          echo "$Gfont <b> <font size='1' color='#922b21'>$Subdepto[subdepto]</font></b></a>";
      }elseif ($Subdepto[subdepto]==$filtroG){
          echo "$Gfont <b> <font size='1' color='#922b21'>$Subdepto[subdepto]</font></b></a>";
      }else{
//        echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&contador=$contador&filtro3=$filtro3&filtro5=$filtro5&FechaI=$FechaI&FechaF=$FechaF&filtro7=$filtro7&filtro9=$Subdepto[subdepto]&HoraI=$HoraI&HoraF=$HoraF'><font size='1'>$Subdepto[subdepto]</font></b></a>";
        echo "$Gfont <b> <a class='pg' href='demandeptodet3.php?filtro=$filtro&contador=$contador&filtroF=$filtro9&filtro3=$filtro3&filtro5=$filtro5&FechaI=$FechaI&FechaF=$FechaF&filtro7=$filtro7&filtro9=$Subdepto[subdepto]&HoraI=$HoraI&HoraF=$HoraF&filtroG=$filtroG'><font size='1'>$Subdepto[subdepto]</font></b></a>";
      }
  }
*/
  echo "<br>";
