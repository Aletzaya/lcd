  ...
  echo "<tr>";
    echo "<td width='26%' valign='top'>";
		...
		if ($Ins2[condiciones]=='CONTADO'){
	        echo " <font color='#000099'><b> &nbsp; $Ins2[condiciones]</b>";
		}else{
			echo " <font color='#CC0000'><b> &nbsp; $Ins2[condiciones]</b>";
		}
        echo "</font><br><b> &nbsp; E-mail: $Ins2[mail]";
        echo "</form>";
   ...
   echo "</td>";
    echo "<td valig='top'>";
        echo "<form name='form3' method='post' action='ordenesnvas.php?op=cl&Vta=$Vta'>";
            ...
            echo "&nbsp; &nbsp; vecs: <font color=#FF0000 size=+2>". $Cli[numveces];
            echo "<br><b><a class='vt' href=javascript:winuni('Upcliente.php?busca=$Ot[cliente]') title='Click para actualizar sus datos'>&nbsp; ".substr($Cli[nombrec],0,35)."</a>";
            echo "</font> / Col.".ucwords(strtolower($Cli[colonia])) . " " . ucwords(strtolower($Cli[municipio]));
        echo "</font>$Gfont<br><b> &nbsp; E-mail: $Cli[mail] </font>";
        echo "</form>";

    echo "</td>";
    echo "<td valign='top'>";
      echo "<form name='form4' method='post' action='ordenesnvas.php?Vta=$Vta&op=md'>";
         echo "$Gfont <strong>MED: </strong>";
         echo "<input class='textos' class='textos' name='Medico' type='text' value='$Ot[medico]' size='10'> ";
         echo "<a href='medicos.php?orden=med.medico&filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*'><img src='lib/lupa_o.gif' alt='Catalogo de medicos' border='0'></a>";
		    echo " &nbsp; Clasif.: <font color=#FF0000 size=+2> $Med[clasificacion] &nbsp; </font>";
        ...
        echo "<font color='#000099'><b>".substr($Med[nombrec],0,45);
		echo "</font><br><b> &nbsp; E-mail: $Med[mail]";
      echo "</form>";
    echo "</td>";
  echo "</tr>";
...
echo "</table>";
  ...
  if(!$res=mysql_query($cSql.$cWhe,$link)){
        ...
        while($registro=mysql_fetch_array($res)){
			...
			echo "<td align='left'><a href=javascript:Ventana('informes/$estud.php')><img src='images/print.png' alt='Elimina' border='0'></a><a href=javascript:winuni('estudiosobs.php?estudio=$registro[estudio]')>$Gfont$registro[estudio]</a></td>";
