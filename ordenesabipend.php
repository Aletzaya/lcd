...
<?php
    ...
    while($rg=mysql_fetch_array($UpA)) {
	 ...
	 echo "<p align='center'><font face='verdana' size='-2'><a href='pidedatos.php?cRep=12&fechas=1&FecI=$FecI&FecF=$FecF'>";
...
<?php
	...
	echo "<form name='form1' method='post' action='pidedatos.php?cRep=12&fechas=1&FecI=$FecI&FecF=$FecF'>";
