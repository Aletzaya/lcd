...
//      echo "<a class='pg' href=javascript:winuni('preanalitico.php?busca=$busca')>Cuestionario pre-analitico </a>";
   ...
   if(!$res=mysql_query($cSqlD." ORDER BY ".$OrdenDef)){
      ...
      $numeroRegistros=mysql_num_rows($res);
        ...
        echo "<td align='center'>$Gfont <b><a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=2&regis=1&status=RECOLECCION&Suc=$He[suc]'>Recol</b></a></td>";
		  ...
		  while($registro=mysql_fetch_array($res))		{
			...
			if($registro[statustom]=='RECOLECCION'){				
               echo "<td align='center'>$Gfont<img src='lib/slc.png'></td>";
				...
				if($registro[statustom]==''){
               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=RECOLECCION&Suc=$He[suc]'>OK</b></a></td>";
				}else{
               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesd.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=RECOLECCION&Suc=$He[suc]'><img src='lib/iconfalse.gif'></b></a></td>";
				}
            }   
