...
//						} 
   ...
   if($Otd[2]=='1'){
     ...
     echo "<td width='100%' height='50' align='center'>";
        ...
        echo "<input name='Imp' face=''Calibri, Courier, mono' type='submit' onClick='print()' value='No.Orden: $Ot[institucion] - $busca'><font size='1'>$Hora";

  		  //echo "<font size='1' face='Verdana, Arial, Helvetica, sans-serif'>&nbsp;#Ord: $busca</font>";

  		  echo "<br>";

  		  echo "<font size='2' face='Calibri, Courier, mono'><strong>$Ot[nombrec]</strong></font>";
		  ...
		  echo "<div align='center'><font size='1' face='Calibri, Courier, mono'><strong><u> $Otd[0] </u><font size='1' face='Calibri, Courier, mono'> - &nbsp;$Otd[1] - <u> $serv </u><div></strong>";
	...
	echo "<img src='barcode.php?text=".$Ot[nombrec]."<tab>".$busca."&size=20&codetype=Code128&print=false' />";
	// <img src="barcode.php?text=0123456789&size=40&codetype=Code39&print=true" />
	echo "</div>";
		...
		echo "<img src='images/logo1.jpg' width='200' height='40'>";
		...
		echo "<font size='1' face='Verdana, Arial, Helvetica, sans-serif'><strong>$Ot[nombrec]</strong></font>";
		...
		echo "<font size='1' face='Verdana, Arial, Helvetica, sans-serif'>Edad: ".$anos." a&ntilde;os &nbsp; $meses Meses </font>";
		...
		echo "<font size='1' face='Verdana, Arial, Helvetica, sans-serif'> $Fecha <input name='Imp' face='Verdana, Arial, Helvetica, sans-serif' type='submit' onClick='print()' value='No.Orden: $Ot[institucion] - $busca'></font>";
		...
		echo "<font size='1' face='Verdana, Arial, Helvetica, sans-serif'>$Otd[0] - &nbsp;$Otd[1] </font>";
		...
		echo "<img src='barcode.php?text=O=".$busca."-E=".$Est."&size=30&codetype=Code128&print=false' />";
