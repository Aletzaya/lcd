  ...
  echo "<form name='form1' method='get' action=".$_SERVER['PHP_SELF']." onSubmit='return ValCampos();'>";
        ...
        while($rg=mysql_fetch_array($Sql)){
			...
			if($Lugar == '6'){
               ...
               echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenrecest.php?Orden=$Orden&Estudio=$rg[estudio]&Recibeencaja=$Recibeencaja&Op=2'>Entregar</a></td>";
            }   
			echo "<td>$Gfont $rg[cinco]</td>";
            echo "<td>$Gfont $rg[recibeencaja]</td>";
			
		  	if($Usr=='nazario' or $Usr=='MARYLIN' or $Usr=='Andrea'){
				echo "<td align='center'>$Gfont &nbsp; <a class='pg' href='ordenrecest.php?Orden=$Orden&Estudio=$rg[estudio]&Op=res'>***RESTAURAR</a></td>";
			}
