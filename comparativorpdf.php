...
//********** DATOS    **********//
    ...
    $output = '<table align="center" width="100%" border="0"><tr bgcolor="#a2b2de"><td align="center" colspan="2"></td><td align="center" colspan="2"> <b>De '.$FechaI.' al '.$FechaF.'</b></td><td align="center" colspan="2"> <b>De '.$FechaI2.' al '.$FechaF2.'</b></td><td align="center" colspan="2"> <b>Diferencia</b></td></tr><tr bgcolor="#a2b2de"><td align="center" colspan="2"> <b>Subdepartamento</b></td><td align="center"> <b>Cant</b></td><td align="center"> <b>Importe</b></td><td align="center"> <b>Cant</b></td><td align="center"> <b>Importe</b></td><td align="center"> <b>Cantidad</b></td><td align="center"> <b>Importe</b></td></tr>';
  ...
  $depto2='';
    ...
    while ($reg1 = mysql_fetch_array($est3)) {
      ...
      if($reg1[depto]<>$depto2){
        ...
        if($depto2==1){
         ...
         $output .= '<tr bgcolor="#7dcea0" onMouseOver=this.style.backgroundColor='.$Gbarra.';this.style.cursor="hand" onMouseOut=this.style.backgroundColor="#7dcea0";><td align="right" colspan="2"><b>Totales----></b></td><td align="center"><b>'.number_format($cantitdepto1,"0").'</b></td><td align="right"><b>'.number_format($importotaldepto1t,"2").'</b></td><td align="center"><b>'.number_format($cantitdepto2,"0").'</b></td><td align="right"><b>'.number_format($importotaldepto2t,"2").'</b></td><td align="center"><b>'.number_format($difimportdepto,"0").'</b></td><td align="right"><b>'.number_format($importotaldepto1t-$importotaldepto2t,"2").'</b></td></tr>';

         $difimportdepto=$cantitdepto1=$cantitdepto2=$importotaldepto1t=$importotaldepto2t=0;

          $output .=  '<tr><td align="center" colspan="8"> &nbsp; </td></tr>';

          $output .=  '<tr bgcolor="#a2b2de" onMouseOver=this.style.backgroundColor='.$Gbarra.';this.style.cursor="hand" onMouseOut=this.style.backgroundColor="#a2b2de";><td align="center" colspan="8"><b>'.$Deptos1[nombre].'</b></td></tr>';
      ...
      if($canti1<>0 or $canti2<>0){
        ...
        $output .= '<tr bgcolor='.$Fdo.'><td colspan="2" align="left">'.$reg1[subdepto].'</td><td align="center">'.number_format($canti1,"0").'</td><td align="right">'.number_format($importotal1,"2").'</td><td align="center">'.number_format($canti2,"0").'</td><td align="right">'.number_format($importotal2,"2").'</td><td  align="center">'.number_format($difcant,"0").'</td><td align="right">'.number_format($difimport,"2").'</td></tr>';
    ...
    $output .= '<tr bgcolor="#a2b2de"><td align="right" colspan="2"><b>Totales Generales --> </b></td><td align="center"><b>'.number_format($cantit1,"0").'</b></td><td align="right"><b>$ '.number_format($importotalt1,"2").'</b></td><td align="center"><b>'.number_format($cantit2,"0").'</b></td><td align="right"><b>$ '.number_format($importotalt2,"2").'</b></td><td align="center"><b>'.number_format($cantit3,"0").'</b></td><td align="right"><b>$ '.number_format($importotalt3,"2").'</b></td></tr>';
...
class MYPDF extends TCPDF {
    ...
    function Footer() {
      ...
      define ("PDF_HEADER_TITLE", "Reporte Comparativo por Subdepartamento - Resumen");
