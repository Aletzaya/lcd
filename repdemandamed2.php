...
<body bgcolor="#FFFFFF">
    ...
    $Tit = "<tr bgcolor='#a2b2de'><td align='center'>$Gfon M&eacute;dico </td><td align='center' colspan='2'>$Gfon Nombre</td>
	<td align='center'>$Gfon Especialidad</td><td align='center'>$Gfon Promotor</td>";
...
//                    $cTit = $cTit . "<td align='center'>$Gfon ".number_format($aCnt[$x],'0')."</font></td>";
				...
				</td><td width='22%'>$Gfont $Nombre </font></td><td aling='rigth' width='5%'>$Gfont <font size='1'>$Status</font></td><td  width='15%'>$Gfont $Esp</font></td><td>$Gfont $Promotor</font></td>";
...
//                    $cTit = $cTit . "<td align='center'>$Gfon ".number_format($aCnt[$x],'0')."</font></td>";
	...
	<td>$Gfont $Nombre</font></td><td aling='rigth'>$Gfont <font size='1'>$Status</font></td><td>$Gfont $Esp</font></td><td>$Gfont $Promotor</font></td>";
	echo $cTit . "<td align='center'>$Gfon ".number_format($SubT,'0')."</td><td align='center'>$Gfon ".number_format($Promedio,'2')." </td>
