<?php
  ...
  $cSql ="SELECT dpag_ref.id,cptpagod.referencia,dpag_ref.fechapago,dpag_ref.observaciones,dpag_ref.monto,dpag_ref.tipopago,dpag_ref.usr,dpag_ref.suc, "
          ...
          . "AND ($Sucursal) order by cptpagod.id";
...
while($rg=mysql_fetch_array($sql)){  
            ...
            if($idconcepto<>$rg[id_nvo]){
              ...
              echo "<td align='center' colspan='2' width='3%'><a class='pg' href=javascript:winuni2('pagosdet.php?Id=$rg[id]')>$Gfont4 <b>$rg[suc]&nbsp; - $rg[orden_h]&nbsp;</b>  </font></a></td>";  
...
echo "<p align='center'><font face='verdana' size='-2'><a href='pidedatos.php
?cRep=42&FecI=$FechaI&FecF=$FechaF'>";
