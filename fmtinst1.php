<?php
  ...
  if(substr($busca,0,1)=='-'){
     ...
     $cSql="SELECT $Qry[campos] FROM $Qry[froms] WHERE inst.institucion='$busca'";
  }else{
     #Armo el query segun los campos tomados de qrys;
     $cSql="SELECT $Qry[campos],inst.institucion FROM $Qry[froms] WHERE $BusInt $Qry[filtro]";
     //echo $cSql;
  }   
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href='visitainste.php?&Inst=$rg[institucion]&busca=NUEVO'><img src='lib/ok.png' alt='Elige este reg' border='0'></td>";
