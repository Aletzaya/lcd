<?php
  ...
  $cSqlH     = "SELECT ot.orden,ot.fecha,ot.hora,ot.fechae,ot.cliente,cli.nombrec,ot.importe,ot.ubicacion,ot.institucion,ot.medico,med.nombrec,ot.status,ot.recibio,ot.institucion,ot.pagada,ot.observaciones,ot.horae,cli.fechan,ot.suc,ot.recepcionista,ot.idprocedencia
                FROM ot,cli,med
            ...
            if($muestras==1 and $registro[estudio]==$Estudio){
				...
				if($registro[indmuestras]=='Varias'){
	              	...
	              	if($registro[statustom]=='TOMA/REALIZ'){				
		               echo "<td align='center'>$Gfont $registro[nmuestras]<img src='lib/slc.png'></td>";
		            }else{
