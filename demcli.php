<?php
  ...
  $cSqlD="select otd.estudio,otd.status,est.descripcion,otd.precio,otd.descuento,est.muestras,otd.etiquetas,ot.fecha,ot.orden from otd,est,ot where otd.estudio=est.estudio and otd.orden=ot.orden and ot.cliente='$busca' ";
