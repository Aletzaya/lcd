...
class MYPDF extends TCPDF {
    ...
    function Header() {
        ...
        $this->Image($image_file2, 8, 5, 80, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
    ...
    function Footer() {
        ...
        $this->Cell(-1000, 15, 'Unidad Matriz', 1, false, 'R', 0, '', 0, false, 'T', 'M');
...
while($Ele=mysql_fetch_array($EleA)){
	...
	$descripcion= utf8_encode($Ele[descripcion]);
	...
	if($Ele[tipo]=='n'){
		...
		$pdf->SetFont('Helvetica', '', 9, '', 'false');	
			...
			if($Res[$Ele[tipo]]>$Ele[max] or $Res[$Ele[tipo]]<$Ele[min]){
				...
				$html ='<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: '.$Fdo.';color: #000;"><td width="20" align="rigth"><img src="images/'.$imagen.'.png" alt="test alt attribute" width="20" height="20" border="0" /></td><td width="400" align="center">'.$descripcion.'</td><td width="180" align="center" height="30" border="1"><b>'.$Res[$Ele[tipo]].'   '.$Ele[unidad].'</b></td><td width="70" align="center" height="30">'.$Ele[min].'</td><td width="20" align="center" height="30">  -  </td><td width="70" align="center" height="30">'.$Ele[max].'</td><td width="410" height="30" style="text-align:justify;"><font size="8">'.$nota.'</font></td></tr></table>';
			}else{

				$html ='<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: '.$Fdo.';color: #000;"><td width="20" align="rigth"></td><td width="400" align="center">'.$descripcion.'</td><td width="180" align="center" height="30">'.$Res[$Ele[tipo]].'   '.$Ele[unidad].'</td><td width="70" align="center" height="30">'.$Ele[min].'</td><td width="20" align="center" height="30">  -  </td><td width="70" align="center" height="30">'.$Ele[max].'</td><td width="410" height="30" style="text-align:justify;"><font size="8">'.$nota.'</font></td></tr></table>';
			...
			$html ='<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: '.$Fdo.';color: #000;"><td width="20" align="rigth"></td><td width="400" align="center">'.$descripcion.'</td><td width="720" align="left" height="30" colspan="6">'.$Res[$Ele[tipo]].'</td></tr></table>';
			...
			if($Res[$Ele[tipo]]==$Ele[vtexto]){
				$html ='<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: '.$Fdo.';color: #000;"><td width="20" align="rigth"></td><td width="400" align="center">'.$descripcion.'</td><td width="180" align="center" height="30">'.$Res[$Ele[tipo]].' '.$Ele[unidad].'</td><td width="160" align="center" height="30" colspan="3">'.$Ele[vtexto].'</td><td width="410" height="30" style="text-align:justify;"><font size="8">'.$nota.'</font></td></tr></table>';
			}else{
				$html ='<table width="800" border="0" cellspacing="0" cellpadding="5"><tr style="background-color: '.$Fdo.';color: #000;"><td width="20" align="rigth"><img src="images/clear.gif" alt="test alt attribute" width="20" height="20" border="0" /></td><td width="400" align="center">'.$descripcion.'</td><td width="180" align="center" height="30"><b>'.$Res[$Ele[tipo]].' '.$Ele[unidad].'</b></td><td width="160" align="center" height="30" colspan="3">'.$Ele[vtexto].'</td><td width="410" height="30" style="text-align:justify;"><font size="8">'.$nota.'</font></td></tr></table>';
			}
...
if($Personal[cedula]<>''){
	...
	$html ='<br><table width="800" border="0" cellspacing="0" cellpadding="0"><tr><td width="150"></td><td width="400" align="center"><b> A T E N T A M E N T E </b></td><td width="100"></td><td width="400" align="center"><b> R E A L I Z O </b></td></tr><tr><td width="150"></td><td width="400" align="center"><img src="Firma2.jpg" alt="test alt attribute" width="250" height="120" border="0" /></td><td width="100"></td><td width="300" align="center"></td></tr><tr><td width="150"></td><td width="400" align="center">'.$Personal1[profesion].' '.$Personal1[nombre].'</td><td width="100"></td><td width="400" align="center">'.$Personal[profesion].' '.$Personal[nombre].'</td></tr><tr><td width="150"></td><td width="400" align="center">Cedula Profesional '.$Personal1[cedula].'</td><td width="100"></td><td width="400" align="center">Cedula Profesional '.$Personal1[cedula].'</td></tr></table>';
...
header("Location: enviocorreo.php?Orden=$Orden&Estudio=$Estudio&Correo=$Correo");
?>
