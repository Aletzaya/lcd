...
//                    if($Otnva[servicio]=="Ordinaria"){$Dias=$cCpo[entord];}else{$Dias=$cCpo[entexp]/24;}
    ...
    $lUp = mysql_query("INSERT INTO ot
          ...
          receta,importe,descuento,pagada,fecpago,medicon,status,horae,suc,folio,datoc,tentregamost,tentregamed,tentregadig,entemailpac,entemailmed,entemailinst,entwhatpac,entwhatmed,idprocedencia)
          VALUES
          ('$Ot[cliente]','$Fecha','$hora','$medico','$Ot[fechar]','$Ot[fechae]','$Ot[inst]',
          '$Ot[diagmedico]','$Ot[observaciones]','$Ot[servicio]','$Usr','$Ot[receta]',$Otd[0],
          '$Ot[descuento]','$cPag','$Fecha','$Ot[medicon]','DEPTO','$Ot[horae]','$Suc','$Folio','$Ot[datoc]','$Ot[tentregamost]','$Ot[tentregamed]','$Ot[tentregadig]','$Ot[entemailpac]','$Ot[entemailmed]','$Ot[entemailinst]','$Ot[entwhatpac]','$Ot[entwhatmed]','$Ot[idprocedencia]')");
