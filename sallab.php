<?php
  ...
  $op      = $_REQUEST[op];
  $Id      = 17; 										                 //Numero de query dentro de la base de datos
  ...
  if($busca >= 'a'){
     ...
     $cSql = "SELECT $Qry[campos] FROM sl WHERE sl.id >= '$busca' $BusInt  $Qry[filtro]";
  ...
  if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           if($rg[status]=='CERRADA'){
              ...
              echo "<td align='center'><a href=javascript:wingral('impsallabpdf.php?busca=$rg[id]')><img src='lib/print.png' alt='Modifica rg' border='0'></td>";
              
           }else{
              echo "<td>&nbsp;</td>";
           }           
           echo "<td align='center'><a href='sallabd.php?busca=$rg[id]'><img src='lib/browse.png' alt='Modifica Registro' border='0'></td>";
