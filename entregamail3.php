...
//  echo "<form name='form1' method='get' action=".$_SERVER['PHP_SELF']." onSubmit='return ValCampos();'>";
  ...
  echo "<tr>";
  echo "<form name='form2' method='post' action='entregamail3.php?Orden=$Orden&Op=actpac'>";		    
  ...
  echo "</form>";
  if($He[entemailpac]=='1'){
	   echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Op=epn'><img src='lib/slc.png'></a></td>";
  }else{
	   echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Op=eps'>NO</a></td>";
  }
  ...
  if($He[entemailmed]=='1'){
	   echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Op=emn'><img src='lib/slc.png'></a></td>";
  }else{
	   echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Op=ems'>NO</a></td>";
  }
  ...
  if($He[entemailinst]=='1'){
	   echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Op=ein'><img src='lib/slc.png'></a></td>";
  }else{
	   echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Op=eis'>NO</a></td>";
  }
...
/*
  if($_REQUEST[Reg3]<>'Todoarch'){
    ...
    echo "<td align='center'>$Gfont2<a href='entregamail3.php?Orden=$Orden&Reg3=Todoarch&Archivo=At'>Adjuntar/arch</a></font></td>";

  }else{

    echo "<td align='center'>$Gfont2<a href='entregamail3.php?Orden=$Orden&Reg3=Todoarchquitar&Archivo=Qt'>Quita/arch</a></font></td>";
    ...
    echo "<td>$Gfont $rg[descripcion]</td>";
      ...
      if($rg[status]<>'' and $rg[usrvalida]<>''){
          ...
          if($rg[depto] <> 2 ){
              ...
              echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Reg3=A&Archivo=$Rarchivo&alterno=$rg[alterno]&Estudio=$rg[estudio]'>$Seleccionado2<font></a></td>"; 
              ...
              echo "<td align='center'><a class='pg' href='entregamail3.php?Orden=$Orden&Reg3=A&Archivo=$Rarchivo&Estudio=$rg[estudio]'>$Seleccionado2<font></a></td>"; 
...
//        echo "<td align='center'>-</td>";
  ...
  if($_REQUEST[Reg]<>'Todoimg'){
    ...
    echo "<font size='2'><a href='entregamail3.php?Orden=$Orden&Reg=Todoimg'>Adjuntar todas las imagenes</a></font>";

  }else{

    echo "<font size='2'><a href='entregamail3.php?Orden=$Orden&Reg=Todoimgquitar'>Quitar todas las imagenes</a></font>";
...
while ($row = mysql_fetch_array($ImgA)) {   
    ...
    if($cExt=='PDF'){
      ...
      echo "<td align='center' onMouseOver=this.style.backgroundColor='$Fdo';this.style.cursor='hand' onMouseOut=this.style.backgroundColor='#FFFFFF';><a class='pg' href='entregamail3.php?Orden=$Orden&Reg=$R&Archivo=$row[archivo]'><img src='pdfenv.png' title='Vista preliminar' border='0' width='40'>$Seleccionado<br>$Gfont $R - $row[archivo] <font></a></td>"; 


    }else{

      echo "<td align='center' onMouseOver=this.style.backgroundColor='$Fdo';this.style.cursor='hand' onMouseOut=this.style.backgroundColor='#FFFFFF';><a class='pg' href='entregamail3.php?Orden=$Orden&Reg=$R&Archivo=$row[archivo]'><IMG SRC='estudios/$foto' border='0' width='70'>$Seleccionado<br>$Gfont $R - $row[archivo] <font></a></td>"; 

    }


      if($R == 5 or $R==10 or $R==15 or $R==20 or $R==25 or $R==30 or $R==35 or $R==40 or $R==45 or $R==50 or $R==55 or $R==60 or $R==65 or $R==70 or $R==75 or $R==80 or $R==85 or $R==90 or $R==95 or $R==100 or $R==105){
        echo "</tr>";
        echo "<tr>";
      }
