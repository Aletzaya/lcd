...
echo "<body bgcolor='#FFFFFF' onload='cFocus()'>";          
  ...
  echo "<form name='form1' method='get' action=".$_SERVER['PHP_SELF']." onSubmit='return ValCampos();'>";
		...
		echo "<font><p align='center'><b>Impresion de Estudios</b></p>";
         ...
         $Sql  = mysql_query("SELECT otd.estudio,est.descripcion,otd.lugar,otd.uno,otd.impeti,otd.recibepac,otd.obsest,otd.etiquetas,otd.statustom,otd.usrest,otd.impest,otd.impres
		 		  FROM otd,est 
          ...
          echo "<td align='center'>$Gfont <b>Fecha de impresion</b></td>";		  
        ...
        while($rg=mysql_fetch_array($Sql)){
			...
			echo "<td align='center'>$Gfont $rg[impres]</td>";
			echo "<td align='center'>$Gfont $rg[impest]</td>";
