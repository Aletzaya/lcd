...
$Team='LCD - Matriz';
$pdf->SetHeaderData('logo.jpg', '45', '    Laboratorio Clinico Duran S.A. de C.V.','                                                                                                                                                 Catalogo de Medicos');//define ("PDF_HEADER_LOGO", "logo_example.png");
...
$reg = mysql_fetch_array(mysql_query("SELECT * FROM med WHERE med.medico='$busca'"));
