...
$Perlab2=mysql_query("select * from perlab where alias='$Usr'",$link);
...
class MYPDF extends TCPDF {
    ...
    function Header() {
        ...
        $this->writeHTML('<table border="1"><tr><td width="20" height="25">&nbsp;</td><td width="450" align="right">Calle José del Castillo No. 3 Altos Col. San José Insurgentes</td></tr><tr><td width="20" height="25">&nbsp;</td><td width="450" align="right">Alcal. Benito Juárez, CDMX</td></tr><tr><td width="20" height="25">&nbsp;</td><td width="450" align="right">Tels. 01 (55) 24 54 79 01,  &nbsp; 01 (55) 24 54 79 02</td></tr><tr><td width="20" height="25">&nbsp;</td><td width="450" align="right">Lada sin costo 01800-161-6122</td></tr></table><hr>', false, 0);
