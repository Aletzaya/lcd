...
//  headymenu($Titulo,0);
  ...
  echo "<tr>";
  echo "<td><font size='2' face='Arial, Helvetica, sans-serif'> <b>No.Orden:  $busca  &nbsp; Cliente: $He[4]</font></b></td>";
  ...
  echo "<td>$Gfont <font color='#ffffff'><b> Importe: $ ".number_format($He[importe],'2')."&nbsp; &nbsp; Abonado: $ ".number_format($SqlS[0],'2')."</b></td>";
