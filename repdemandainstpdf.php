...
class MYPDF extends TCPDF {
    ...
    function Header() {
        ...
        $this->writeHTML('<table width="100"><tr><td width="78"></td><td width="1000"></td></tr><tr><td width="78"></td><td width="1000"></td></tr><tr><td width="78">&nbsp;</td><td width="1000">Demanda de afluencia de pacientes por institucion del '.$FechaI.' al '.$FechaF.'</td></tr></table><hr>', false, 0);
	...
	$Tit1 = '<br><table border="1" width="99.2%"><tr style="background-color: #0d486a; color:#FFF;" align="center"><th height="30"><b>INST</b></th><th><b>NOMBRE</b></th><th><b>CONDIC.</b></th><th><b>PROMOTOR</b></th>';
        ...
        if ($reg[institucion] <> $Inst) {
            ...
            if ($Inst <> 'XXX') {
                ...
                for ($i = $Ini; $i <= $Fin; $i = $i + 1) {
					...
					$cOtC= "select inst,count(*),date_format(vinst.fecha,'%Y%m') from vinst WHERE vinst.inst='$Inst' and date_format(vinst.fecha,'%Y%m')='$i'";
                ...
                $html3= $cTit . '<th align="center">'.number_format($SubTot,"0").'</th><th align="right">'.number_format($SubT,"2").'</th><th align="center">'.number_format($Promedioot,"0").'</th><th align="right">'.number_format($Promedio,"2").' </th><th align="right">'.number_format($Venta,"2").'</th><th align="right">'.number_format($SubT-$Venta,"2").'</th></tr>';
...
$Tit6 = '</table>';
	...
	$html1='<tr style="background-color: #C0C0C0; color:#000;"><th height="30"><b>TOTALES:</b></th><th colspan="3"><b>INSTITUCIONES --> '.$nRng.'</b></th>';

	$html3= $cTit . '<th align="center"><b>'.number_format($GraTot,"0").'</b></th><th align="right"><b>'.number_format($GraT,"2").'</b></th><th align="center"><b>'.number_format($PromedioGot/$GraTot,"0").'</b></th><th align="right"><b>'.number_format($PromedioG/$GraT,"0").'</b></th><th align="right"><b>'.number_format($VentaT,"0").'</b></th><th align="right"><b>'.number_format($GraT-$VentaT,"0").'</b></th></tr>';
