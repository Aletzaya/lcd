...
while($Imagenes=mysql_fetch_array($ImagenesC)){
    ...
    $Path[$RG] = "estudios/".$Imagenes[archivo];
    $RG++;
...
/*
        $mail->AddAttachment($Path[1],$Img[1],'base64','application/octet-stream');
        $mail->AddAttachment($Path[2],$Img[2],'base64','application/octet-stream');
        $mail->AddAttachment($Path[3],$Img[3],'base64','application/octet-stream');
        $mail->AddAttachment($Path[4],$Img[4],'base64','application/octet-stream');
*/
   // }

   // $mail->AddAttachment($Path,$Path2,"base64","application/octet-stream");
    //$mail->AddAttachment($Path,$Path,'base64','application/octet-stream');
    //$mail->AddAttachment($Img,$Img,'base64','application/octet-stream');
