...
<?php
 ...
 if(!$res=mysql_query($cSql)){
    ...
    echo "<a href='estudiosd.php'><img src='lib/regresa.jpg' border='0' height='30'></a>";
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a class='seleccionar' href='estudiosd.php?Producto=$rg[clave]'>$Gfont seleccionar</td>";
