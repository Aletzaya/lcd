...
<?php
 ...
 //echo $cSql;
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href=facturase.php?busca=$rg[id]><img src='lib/edit.png' alt='Edita registro' border='0'></a></td>";

           echo "<td align='center'><a href=facturasd.php?busca=$rg[id]&pagina=$pagina><img src='lib/browse.png' alt='Detalle' border='0'></a></td>";
            ...
            if($rg[status] == 'Timbrada'){
                  ...
                  echo "<td align='center'><a href=javascript:winuni('?busca=$rg[id]&op=download')><img src='lib/Pdf.gif' alt='Imprime copia pdf' border='0'></a></td>";
                  echo "<td align='center'><a href=javascript:winuni('?busca=$rg[id]&op=xml')><img src='lib/Xml.gif' alt='Imprime copia pdf' border='0'></a></td>";
            }else{
