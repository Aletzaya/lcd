...
echo "<table align='center' width='100%' border='0'>";
	...
	echo "</form>";
    echo "</td><td aling='center'><a href=javascript:winuni('repdemandainstpdf.php?pagina=$pagina&Sort=Asc&busca=$busca&filtro=$filtro&filtro3=$filtro3&filtro5=$filtro5&filtro7=$filtro7&filtro9=$filtro9&FechaI=$FechaI&FechaF=$FechaF')><img src='pdfenv.png' alt='pdf' border='0'></a></td></tr></table>";
...
//                    $cTit = $cTit . "<td align='center'>$Gfon ".number_format($aCnt[$x],'0')."</font></td>";
					...
					onMouseOver=this.style.backgroundColor='$Gbarra';this.style.cursor='hand'
					onMouseOut=this.style.backgroundColor='$vist';>$Gfont ".number_format($aCnt[$x],'0')."</font></td>";
                ...
                echo $cTit . "<td align='right'>$Gfont ".number_format($SubTot,'0')."</td><td align='right'>$Gfont ".number_format($SubT,'0')."</td><td align='right'>$Gfont ".number_format($Promedioot,'2')." </td><td align='right'>$Gfont ".number_format($Promedio,'0')." </td>
				<td align='right'>$Gfont ".number_format($Venta,'0')."</font></td><td align='right'>$Gfont ".number_format($SubT-$Venta,'0')."</font></td>
				...
				if($Promotor=='Promotor_A'){
					...
					$PromotorA1=$PromotorA1+$SubTot;
					$PromotorA2=$PromotorA2+$SubTot;

				}elseif($Promotor=='Promotor_B'){
					
					$PromotorB1=$PromotorB1+$SubTot;
					$PromotorB2=$PromotorB2+$SubTot;

				}elseif($Promotor=='Promotor_C'){
					
					$PromotorC1=$PromotorC1+$SubTot;
					$PromotorC2=$PromotorC2+$SubTot;
					
				}elseif($Promotor=='Promotor_D'){
					
					$PromotorD1=$PromotorD1+$SubTot;
					$PromotorD2=$PromotorD2+$SubTot;
...
//                    $cTit = $cTit . "<td align='center'>$Gfon ".number_format($aCnt[$x],'0')."</font></td>";
	...
	echo $cTit . "<td align='right'>$Gfont ".number_format($SubTot,'0')."</td><td align='right'>$Gfont ".number_format($SubT,'0')."</td><td align='right'>$Gfont ".number_format($Promedioot,'0')." </td><td align='right'>$Gfont ".number_format($Promedio,'0')." </td>
	<td align='right'>$Gfont ".number_format($Venta,'0')."</font></td><td align='right'>$Gfont ".number_format($SubT-$Venta,'0')."</font></td>
	<td align='center'><a href=javascript:winuni('visitasmed.php?FechaI=$Ini&FechaF=$Fin&Med=$Med')>$Gfon $OtB[1]</a></font></td></tr>";
	$Tvisit+=$OtB[1];
    $cTit = '';
    for ($i = $Ini; $i <= $Fin; $i = $i + 1) {
        ...
        $cTit = $cTit . "<td align='right'>$Gfon2 <b>".number_format($tCntot[$x],'0')."</b></font></td><td align='right'>$Gfon2 <b>".number_format($tCnt[$x],'0')."</b></font></td>";
    }
	$PromedioG= $GraT/$Cmes;
    ...
    echo $cTit. "<td align='right'>$Gfon2 <b>".number_format($GraTot,'0')."</b></td><td align='right'>$Gfon2 <b>".number_format($GraT,'0')."</b></td>
	<td align='right'>$Gfon2 <b>".number_format($PromedioGot/$GraTot,'0')."</b>
	</td><td align='right'>$Gfon2 <b>".number_format($PromedioG/$GraT,'0')."</b>
	</td><td align='right'>$Gfon2 <b>".number_format($VentaT,'0')."</b></td><td align='right'>$Gfon2 <b>".number_format($GraT-$VentaT,'0')."</b></td>
	...
	echo $cTit. "<td align='right' bgcolor='#a2b2de'>$Gfon2 <b>".number_format($GraTot,'0')."</b></td><td align='right' bgcolor='#a2b2de'>$Gfon2 <b>".number_format($GraT,'0')."</b></td><td align='right'></td><td align='right'></td><td align='right'></td><td align='right'></td><td align='center'></td></tr>";
