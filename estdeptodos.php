   ...
   if(!$res=mysql_query($SqlA." ORDER BY ".$OrdenDef,$link)){
	...
	//echo $sql;
        ...
        //  echo "<td align='center'>$Gfont<font size='1'><b>DCM</b></td>";
          ...
          echo "<option value='S/CAPTURA'>S/CAPTURA</option>";
          $Stat=$_REQUEST[Stat];
...
//        PonEncabezado();         #---------------------Encabezado del browse----------------------
	  ...
	  while($registro=mysql_fetch_array($res)){
	  	...
	  	if($statuscap=='S/CAPTURA' and $sipdf==0){
...
// --------------- N O M B R E     D E  L     P A  C I E N T E ----------
		...
		if($registro[fechaest]<>'0000-00-00 00:00:00'){
		  ...
		  echo "<td>$Gfont5 <font size='1' color='#e20909'><b>S/CAPTURA</b></font></td>";
	...
	/*	  if($registro[status] <> 'CANCELADA'){
      ...
      }elseif($statuscap==' '){ //************* toda la captura   *****///////////////////
