...
if($nMsj==0){
	...
	echo " | Sin leer <a class='pg' href=javascript:winuni('msjrec.php')><img src='sobre.gif' width='10' height='10' border='0'> $nMsj msj(s)</a>";
}
...
require ('config.php');
global $numeroRegistros,$orden,$aIzq,$aDat,$aDer,$aCps,$cFuncion,$Sort,$Fech2,$Fech3;   #P k reconoscan el valor k traen
//global $pagina,$numeroRegistros,$orden,$busca,$aIzq,$aDat,$aDer,$aCps,$cFuncion,$Sort;   #P k reconoscan el valor k traen
	  ...
	  for ($i = 0; $i < sizeof($aDat); $i=$i+3) {
	       ...
	       if($orden==$aCps[$x]){			//Es el campo por el cual esta en este momento ordenado;
             ...
             echo "<th background='lib/bartit.gif'><a class='pg' href='".$_SERVER["PHP_SELF"]."?orden=$Pso&Sort=$Srt&filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*&Fech2=$Fech2&Fech3=$Fech3'>$aDat[$i] <img src='lib/$iImg' border='0'> </a></th>";

	       }else{
             echo "<th background='lib/bartit.gif'><a class='pg' href='".$_SERVER["PHP_SELF"]."?&orden=$Pso&Sort=Asc&filtro=*&filtro3=*&filtro5=*&filtro7=*&filtro9=*&Fech2=$Fech2&Fech3=$Fech3'>$aDat[$i] </a></th>";
	       }
          $x++;
	  }
...
global $inicio,$Msj,$cSql,$pagina,$tamPag,$orden,$numPags,$final,$busca,$nRng,$Sort,$Id,$numeroRegistros,$Fech2,$Fech3;
     ...
     if($numPags <= 10 ){
        ...
        for($i=1;$i<=$numPags;$i++)    {
            ...
            if($i==$pagina){
               ...
               echo "<a class='pg' href='".$_SERVER["PHP_SELF"]."?busca=$busca&pagina=$i&Fech2=$Fech2&Fech3=$Fech3'>&nbsp; $i &nbsp;</a>";
		  ...
		  if($pagina >= 7){
           ...
           echo "<a href='".$_SERVER["PHP_SELF"]."?busca=$busca&pagina=1&Fech2=$Fech2&Fech3=$Fech3'><img src='lib/imini.gif' border='0'></a>&nbsp;";
			  ...
			  if($pagina-11>=1){
               ...
               echo " <a href='".$_SERVER["PHP_SELF"]."?busca=$busca&pagina=$pg&Fech2=$Fech2&Fech3=$Fech3'><img src='lib/imant.gif' border='0'></a>&nbsp; ";
        ...
        for($i=$ini;$i<=$fin;$i++)    {
            ...
            if($i==$pagina){
               ...
               echo "<a class='pg' href='".$_SERVER["PHP_SELF"]."?busca=$busca&pagina=$i&Fech2=$Fech2&Fech3=$Fech3'> $pag &nbsp; </a>";
		  ...
		  if($pagina+11 <= $numPags){
           ...
           $pg = $pagina + 11;
           echo " <a href='".$_SERVER["PHP_SELF"]."?busca=$busca&pagina=$pg&Fech2=$Fech2&Fech3=$Fech3'><img src='lib/imsig.gif' border='0'></a>&nbsp; ";

		  }

		  if($pagina < ($numPags-5)){

           echo "<a href='".$_SERVER["PHP_SELF"]."?busca=$busca&pagina=$numPags&Fech2=$Fech2&Fech3=$Fech3'><img src='lib/imfin.gif' border='0'></a>&nbsp;";
...
global $inicio,$Msj,$cSql,$pagina,$tamPag,$orden,$numPags,$final,$busca,$nRng,$Sort,$Id,$numeroRegistros,$Depto,$Subdepto,$Suc,$Fech2,$Fech3,$Stat,$Ord;
#P k reconoscan el valor k traen
     ...
     if($numPags <= 10 ){
        ...
        for($i=1;$i<=$numPags;$i++)    {
            ...
            if($i==$pagina){
               ...
               echo "<a class='pg' href='".$_SERVER["PHP_SELF"]."?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&busca=$busca&pagina=$i&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'>&nbsp; $i &nbsp;</a>";
		  ...
		  if($pagina >= 7){
           ...
           echo "<a href='".$_SERVER["PHP_SELF"]."?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&busca=$busca&pagina=1&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><img src='lib/imini.gif' border='0'></a>&nbsp;";
			  ...
			  if($pagina-11>=1){
               ...
               echo " <a href='".$_SERVER["PHP_SELF"]."?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&busca=$busca&pagina=$pg&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><img src='lib/imant.gif' border='0'></a>&nbsp; ";
        ...
        for($i=$ini;$i<=$fin;$i++)    {
            ...
            if($i==$pagina){
               ...
               echo "<a class='pg' href='".$_SERVER["PHP_SELF"]."?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&busca=$busca&pagina=$i&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'> $pag &nbsp; </a>";
		  ...
		  if($pagina+11 <= $numPags){
           ...
           $pg = $pagina + 11;
           echo " <a href='".$_SERVER["PHP_SELF"]."?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&busca=$busca&pagina=$pg&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><img src='lib/imsig.gif' border='0'></a>&nbsp; ";

		  }

		  if($pagina < ($numPags-5)){

           echo "<a href='".$_SERVER["PHP_SELF"]."?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&busca=$busca&pagina=$numPags&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><img src='lib/imfin.gif' border='0'></a>&nbsp;";
...
echo "<a  class='pg'  href='$_SERVER[PHP_SELF]?pagina=0&Sort=Asc&busca=&orden=ot.orden'>Limpia pantalla</a>";
