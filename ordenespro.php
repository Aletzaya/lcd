<?php
  ...
  if( $busca == ''){
     $cSql="SELECT $Qry[campos],ot.ubicacion,ot.encaja,ot.status,ot.pagada,ot.entemailpac,ot.entemailmed,ot.entemailinst,ot.hora,ot.horae,ot.recepcionista,cli.numveces,cli.cliente,ot.idprocedencia
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
    ...
    echo "&nbsp; $Gfont <font size='2'><b> Suc: </b></font><a class='vt' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=*'>$Todas</a>&nbsp; &nbsp;<a class='vt' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=1'>$uno</a>&nbsp; &nbsp;<a class='vt' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=2'>$dos</a>&nbsp; &nbsp;<a class='vt' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=3'>$tres</a>&nbsp; &nbsp;<a class='vt' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=4'>$cuatro</a>&nbsp; &nbsp;<a class='vt' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=5'>$cinco</a>&nbsp; &nbsp;$NoConform";
		
     //PonEncabezadopro();         #---------------------Encabezado del browse----------------------

    echo "<table align='center' width='99%' border='0' cellspacing='0' cellpadding='0'>";

    echo "<tr height='12' bgcolor='#a2b2de'>";

    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=suc'>Suc</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=ord'>Inst-Ord</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=fecha'>Fech/Hor Cap</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=fechaent'>Fech/Hor Ent</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=cliente'>Cliente</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=captura'>Captura</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>NC</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>Lab</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>RX</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>Otro</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>Det</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>Status</b></a></td>";
    echo "<td align='center'>$Gfont <b><a class='pg' href='ordenespro.php?Fech2=$Fech2&Fech3=$Fech3&Suc=$Suc&Ord=$Ord'>E-mail</b></a></td>";
    ...
    echo "</tr>";              
      ...
      while($rg=mysql_fetch_array($res)){
          ...
          echo "<td align='center'>$Gfont <font size='1'>$rg[suc]</font></td>";
          ...
          echo "<td align='left'>$Gfont <font size='1'>$rg[nombrec] [ <a class='pg' href=javascript:winuni2('repots.php?busca=$rg[cliente]')><font size='2'><b> $rg[numveces]</b></a></font> ] $minutos $alerta</td>";
          ...
          echo "<td align='center'><a href=ordenesdet.php?busca=$rg[orden]&pagina=$pagina&Suc=$Suc&NC=$NC><img src='images/editar_icon.png' alt='Detalle' border='0' width='13'></a></td>";
