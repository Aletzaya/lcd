...
echo "<hr noshade style='color:000099;height:1px'>";
   ...
   echo "<form name='form1' method='post' action='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'>";
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=*&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font color=$marcat><font size='1'>Todos los Deptos</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=1&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font color=$marca1><font size='1'>Laboratorio</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=2&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font color=$marca2><font size='1'>Rayos X y USG</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=3&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font color=$marca3><font size='1'>Especiales</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=4&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font color=$marca4><font size='1'>Servicios</b></a></td>";
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=6&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font color=$marca6><font size='1'>Externos</b></a></td>";

   echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";

	echo "<form name='form' method='post' action='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=ord'>";
   ...
   echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=*&Subdepto=*&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=ord'><font color=$marcat><font size='1'>Todos Subdeptos</b></a></td>";
      
	  while ($Subdepto=mysql_fetch_array($SubA)){
		  if ($Subdepto[subdepto]==$_REQUEST[Subdepto]){
  	   		echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=$Subdepto[departamento]&Subdepto=$Subdepto[subdepto]&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font size='1' color='#F000000'>$Subdepto[subdepto]</font></b></a></td>";
		  }else{
	   		echo "<td>$Gfont <b> <a class='pg' href='estdeptoN.php?Depto=$Subdepto[departamento]&Subdepto=$Subdepto[subdepto]&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=$Ord'><font size='1'>$Subdepto[subdepto]</font></b></a></td>";
		  }
	  }
			$Subdepto=$_REQUEST[Subdepto];
   ...
   echo "<td> <b> <a class='pg' href='estdeptoN.php?Depto=*&Subdepto=*&Suc=$Suc&Fech2=$Fecha&Fech3=$Fecha&Stat=*&Ord=ord'><font color='#4a87ae'><font size='1'>Limpia</b></a></font></td>";
   ...
   if(!$res=mysql_query($SqlA." ORDER BY ".$OrdenDef,$link)){
        ...
        $res=mysql_query($sql,$link);
          ...
          echo "<td align='center'>$Gfont <b><a class='pg' href='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=ord'>Inst-Ord</b></a></td>";
          ...
          echo "<td align='center'>$Gfont <b><a class='pg' href='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=pac'>Paciente</b></a></td>";

          //echo "<td align='center'>$Gfont<font size='1'><b>Cve-Estudio</b></td>";
		  
          echo "<td align='center'>$Gfont <b><a class='pg' href='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Ord=est'>Cve-Estudio</b></a></td>";
			...
			if($registro[statustom]=='TOMA/REALIZ'){				
               echo "<td align='center'>$Gfont <font size='1'>$registro[usrest]</font></td>";
				...
				if($registro[statustom]==''){
               		echo "<td align='center'>$Gfont<a class='pg' href='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Orden2=$registro[orden]&Estudio=$registro[estudio]&regis=1&statustom=TOMA/REALIZ&Suc=$registro[suc]&op=1&pagina=$pagina&Ord=ord'><img src='lib/iconfalse.gif'></b></a></td>";

				}elseif($registro[statustom]=='PENDIENTE'){
               		echo "<td align='center'>$Gfont<a class='pg' href='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Orden2=$registro[orden]&Estudio=$registro[estudio]&regis=1&statustom=TOMA/REALIZ&Suc=$registro[suc]&op=1&pagina=$pagina&Ord=ord'>$registro[statustom]</b></a></td>";
				}else{
...
//----------  C A P T U R A   ---------------------
		  ...
		  if($registro[depto] <> 2 ){
		  	...
		  	echo "<td align='center'><a href=javascript:Ventana('capturaresdiagvalidapdf.php?busca=$registro[orden]&estudio=$registro[estudio]&alterno=$registro[alterno]')><img src='images/editapdf2.png' alt='Edita reg' border='0'> </td>";
...
// --------------- P R O C E S O  ----------
		...
		if($registro2[usrrec]<>''){				
	   		...
	   		echo "<td align='center'><a class='pg' href='estdeptoN.php?Depto=$Depto&Subdepto=$Subdepto&Suc=$Suc&Fech2=$Fech2&Fech3=$Fech3&Stat=$Stat&Orden2=$registro[orden]&Estudio2=$registro[estudio]&op=Rec&pagina=$pagina&Ord=ord'><img src='lib/iconfalse.gif'></b></a></td>";
		}       		
...
// --------------- N O M B R E     D E  L     P A  C I E N T E ----------
		...
		if($registro[entemailpac]=='1' or $registro[entemailmed]=='1' or $registro[entemailinst]=='1'){ 
			echo "<td align='center'><a class='pg' href=javascript:winuni2('entregamail.php?Orden=$registro[orden]')><img src='lib/email.png' border='0'></a></td>";   
		}else{
