<?php
  ...
  #Variables comunes;
  $Titulo = "Elementos por estudio Alterno 2";
  $op     = $_REQUEST[op];
  $Msj    = $_REQUEST[Msj];
  $Id     = 34; 
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href='elementosaltpdf2.php?cVar=$rg[estudio]'><img src='lib/browse.png' alt='Modifica Registro' border='0'></td>";
