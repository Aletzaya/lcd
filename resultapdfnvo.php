...
class MYPDF extends TCPDF {
    ...
    function Header() {
        ...
        $this->writeHTML('<table width="100"><tr><td width="500">&nbsp;</td><td width="700">'.$institucion.' - '.$Orden.' &nbsp;&nbsp; '.$nombrecli.' &nbsp;&nbsp; '.$edad.' &nbsp;'.$link.'</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<table width="100"><tr><td width="500">&nbsp;</td><td width="700">Sexo: '.$sexo.' &nbsp;&nbsp;&nbsp;  Fecha: '.$FechaLet.'</td></tr></table>', false, 0);
      ...
      //  $this->writeHTML('<table width="100"><tr><td width="450">'.write1DBarcode('O='.$Orden.'&E='.$Estudio, 'C128A', '', '', '', 7, 0.3, $style, 'N').'</td><td width="700">&nbsp;</td></tr></table>', false, 0);
        ...
        $this->writeHTML('<br><br><hr><br>', false, 0);
