<?php
  ...
  $Fechaobs  = date("Y-m-d H:i:s");
	...
	if($boton=='Enviar'){
   		...
   		$Up  = mysql_query("UPDATE otd SET obsest='$Obsest',usrobsest='$Usr',fechobsest='$Fechaobs',status='CANCELADA'
...
echo "<body bgcolor='#FFFFFF' onload='cFocus()'>";          
  ...
  echo "<form name='form1' method='get' action=".$_SERVER['PHP_SELF']." onSubmit='return ValCampos();'>";
		...
		echo "$Gfont <font size='+1' color='#e20909'><p align='center'><b>CANCELACION DE ESTUDIO</b></font></p>";
        ...
        echo "<td align='center'>$Gfont2 Motivo de la Cancelacion</td>";
