   ...
   if($Otd[2]=='1'){
     ...
     echo "<td width='50%' height='50' align='center'>";
	  ...
	  echo "<img src='images/logo1.jpg' width='200' height='40'><font size='1' face='Verdana, Arial, Helvetica, sans-serif'><strong><br>&nbsp;Laboratorio Clinico Duran S.A de C.V.</strong></font>";
  	  ...
  	  echo "<font size='1' face='Verdana, Arial, Helvetica, sans-serif'>Edad: ".$anos." a&ntilde;os &nbsp; $meses Meses &nbsp; <p> Fecha:&nbsp;$Fecha";
...
/*
if(substr($Dos,0,4)=='0000' AND $_REQUEST[op]=='1'){ //Actualizo la fecha y hora del paso 2, que es imprisiion de et.;

  $Fecha = date("Y-m-d");
  $Hora  = date("h:i");

  if($Lugar=='1'){
     $Up    = mysql_query("UPDATE otd set dos = '$Fecha $Hora', lugar='2' 
	           WHERE orden='$busca' and estudio='$Est'"); 
  }else{
     $Up    = mysql_query("UPDATE otd set dos = '$Fecha $Hora' 
	           WHERE orden='$busca' and estudio='$Est'");   
  }	
