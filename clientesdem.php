<?php
  ...
  $Titulo="Clientes de mayor demanda";
  ...
  $cSql="select count(ot.orden) as ordenes,ot.cliente,sum(ot.importe) from $Tabla group by cliente ";
  ...
  if(!$res=mysql_query($cSql.$cWhe,$link)){
       ...
       $numeroRegistros=mysql_num_rows($res);
		...
		while($registro=mysql_fetch_array($res)){  ?>
          ...
          <td align='right'><a href="javascript:Ventana('demcli.php?busca=<?php echo $registro[1];?>')"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#0066FF"><b><? echo $registro[1]; ?></b></font></td>
