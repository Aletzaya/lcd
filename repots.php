<?php
  ...
  $cSql    = "SELECT ot.orden,ot.fecha,ot.fechae,ot.cliente,cli.nombrec,ot.importe,ot.status,ot.ubicacion,
             ot.institucion,ot.recepcionista 
             FROM ot,cli 
             WHERE ot.cliente=cli.cliente AND ot.cliente = '$busca'";
  
  $Edit   = array("Edit","Det","Orden","Fecha","Cliente","Nombre","Importe","Status","Inst","Recep","Pagda"
...
<?php 
  ...
  //echo $cSql.$cWhe;
        ...
        while($registro=mysql_fetch_array($res)){
            ...
            echo "<td>$Gfont $registro[orden]</font></a></td>";
            ...
            echo "<td>$Gfont $registro[pagada]</font></td>";
            echo "</tr>";
            $nRng++;
        }//fin while
