...
echo "<body bgcolor='#FFFFFF'>";
   	...
   	echo "<th align='center' height='26'>$Gfont Concepto</th>";
		echo "</tr>";

      $PgsA   = mysql_query("SELECT * FROM $tabla WHERE orden='$busca' order by fecha desc"); 
  ...
  echo "<div align='center'>$Gfont <b> $nRng Modificaciones de Observaciones $busca <b></div><br>";
