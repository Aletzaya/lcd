<?php
  ...
  if ($_REQUEST[Ok] == 'Ok') {
	...
	$Up = mysql_query("UPDATE otd SET nmuestras='$nmuestras' WHERE orden='$busca' AND estudio='$Estudio'");
  ...
  if($_REQUEST[Boton] == Aceptar){        //Para agregar uno nuevo
  	    ...
  	    $cobser     = "SELECT ot.observaciones
			...
			$lUp2   = mysql_query("UPDATE ot set observaciones='$obs' WHERE orden='$busca'");

			$lUp3  = mysql_query("INSERT INTO logobs (fecha,orden,usr,concepto) VALUES
		('$Fechaest','$busca','$Usr','Agregar Obs: $_REQUEST[Observaciones]')");
  ...
  if($_REQUEST[op] == 'cb'){        //Para agregar uno nuevo
	...
	if($opc<>''){
		...
		$lUp=mysql_query("UPDATE ot set idprocedencia = '$opc' WHERE orden='$busca'",$link);

	}

  $cSqlH     = "SELECT ot.orden,ot.fecha,ot.hora,ot.fechae,ot.cliente,cli.nombrec,ot.importe,ot.ubicacion,ot.institucion,ot.medico,med.nombrec,ot.status,ot.recibio,ot.institucion,ot.pagada,ot.observaciones,ot.horae,cli.fechan,ot.suc,ot.recepcionista,cli.numveces,ot.idprocedencia
                FROM ot,cli,med
                WHERE ot.cliente=cli.cliente AND ot.medico=med.medico AND ot.orden='$busca'";

  $cSqlD     = "SELECT otd.estudio,otd.status,est.descripcion,otd.precio,otd.descuento,est.muestras,otd.etiquetas,otd.capturo,est.depto,otd.recibeencaja,otd.uno,otd.dos,otd.tres,otd.cuatro,otd.cinco,otd.seis,otd.statustom,otd.obsest,otd.usrest,otd.fechaest,otd.etiquetas,otd.alterno,otd.creapdf,otd.noconformidad,est.indmuestras,otd.nmuestras
                FROM otd,est
				 ...
				 $Est  = $Otd[estudio];  
				  if(substr($Otd[dos],0,4)=='0000'){     
					...
					if (empty($registro4)) {
						...
						VALUES
						('$busca','$Est','$_REQUEST[Suc]','$Fecha','$Hora','$Usr')");
					}else{
						$lUp    = mysql_query("UPDATE maqdet SET orden='$busca',estudio='$Est',mint='$_REQUEST[Suc]',fenv='$Fecha',henv='$Hora',usrenv='$Usr' WHERE maqdet.orden='$busca' AND maqdet.estudio='$Est' limit 1");
					}  	
			 	}
...
//						} 
   ...
   echo "<br><table align='center' width='95%' cellpadding='0' cellspacing='1' border='0'>";

   echo "<tr bgcolor ='#618fa9'>";

	  if($He[idprocedencia]=='ambu'){
	      $alerta=" <img src='images/ambu.png' width='35' height='35'>";
	  }elseif($He[idprocedencia]=='silla'){
	      $alerta=" <img src='images/silla.png' width='35' height='35'>";
	  }elseif($He[idprocedencia]=='terceraedad'){
	      $alerta=" <img src='images/terceraedad.png' width='35' height='35'>";
	  }elseif($He[idprocedencia]=='problemasv'){
	      $alerta=" <img src='images/problemasv.png' width='35' height='35'>";
	  }elseif($He[idprocedencia]=='bebe'){
	      $alerta=" <img src='images/bebe.png' width='35' height='35'>";
	  }else{
	      $alerta=" <img src='images/all.png' width='35' height='35'>";
	  }
	...
	if($opm=='abrir'){ 
		...
		if($He[idprocedencia]=='ambu'){
			...
			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc= &opm=cerrar'><img src='images/all.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";


		}else{

			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=ambu&opm=cerrar'><img src='images/ambu.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";

		}
 
		if($He[idprocedencia]=='silla'){

			echo " <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc= &opm=cerrar'><img src='images/all.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br></td>";

		}else{

			echo " <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=silla&opm=cerrar'><img src='images/silla.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br></td>";
		...
		if($He[idprocedencia]=='terceraedad'){
			...
			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=terceraedad&opm=cerrar'><img src='images/terceraedad.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";

		}

		if($He[idprocedencia]=='problemasv'){

			echo " <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc= &opm=cerrar'><img src='images/all.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> ";


		}else{

			echo " <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=problemasv&opm=cerrar'><img src='images/problemasv.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> ";
		...
		if($He[idprocedencia]=='bebe'){
			...
			echo "<td width='3%' align='center' bgcolor ='#FFFFFF' rowspan='2'> <a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opc=bebe&opm=cerrar'><img src='images/bebe.png' onmouseover='this.width=35;this.height=35;' onmouseout='this.width=25;this.height=25;' width='25' height='25' alt='' /></a> <br><br>";

		}

		echo "<td width='3%' align='center' bgcolor ='#FFFFFF'><a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opm=cerrar'>$alerta</a></td>";

	}else{

		echo "<td width='3%' align='center' bgcolor ='#FFFFFF'><a class='vt' href='ordenesdet.php?busca=$busca&pagina=$pagina&Suc=$Suc&NC=$NC&opm=abrir'>$alerta</a></td>";

	}

	if($Cambia=='No'){
		echo "<td> <form name='form5' method='post' action='ordenesdet.php?cambia=SI&busca=$busca'>$Gfont <font color='#ffffff' size='3'>Cliente: $He[cliente] $He[5] <p> &nbsp; Edad:  $anos A&ntilde;os $meses Meses &nbsp;&nbsp; F. Nac.: $He[fechan]&nbsp;&nbsp; No. Veces: <a class='pg' href=javascript:winuni2('repots.php?busca=$He[cliente]')><font color='Red' size='4'><b>$He[numveces]</b></a></font></td>
		...
		echo "<td> <form name='form5' method='post' action='ordenesdet.php?op=cb&busca=$busca'> $Gfont <font color='#ffffff' size='3'>Cliente: $He[cliente] $He[5] <p> &nbsp; Edad:  $anos A&ntilde;os $meses Meses &nbsp;&nbsp; F. Nac.: $He[fechan]</td>
		<td>$Gfont <font color='#ffffff'>Fech/Hra: $He[fecha]&nbsp;".substr($He[hora],0,5)."&nbsp;&nbsp;&nbsp;
		Fech/entga: <input name='Fechae' type= 'text' size='10' value='$He[fechae]'> &nbsp; <input name='Horae' type= 'text' size='8' value='$He[horae]'>
		<INPUT TYPE='SUBMIT' name='Cambia' value='Cambia'></td></form>";
	}
   ...
   echo "<td>$Gfont Medico: $He[medico] $He[10] </td><td>$Gfont Capturo: $He[recepcionista]</td>";
...
//      echo "<a class='pg' href=javascript:winuni('preanalitico.php?busca=$busca')>Cuestionario pre-analitico </a>";
   ...
   if(!$res=mysql_query($cSqlD." ORDER BY ".$OrdenDef)){
      ...
      $numeroRegistros=mysql_num_rows($res);
        ...
        echo "<td align='center'>$Gfont <b><a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=2&regis=1&status=TOMA/REALIZ&Suc=$He[suc]'>Tma/Rea</b></a></td>";
        //echo "<td align='center'>$Gfont <b><a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=2&regis=1&status=RECOLECCION&Suc=$He[suc]'>Recol</b></a></td>";
        echo "<td align='center'>$Gfont <font size='1'><b>Recol</b></td>";
        echo "<td align='center'>$Gfont <b><a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=2&Estudio=TODOS&status=PENDIENTE'>Pend</b></a></td>";
        echo "<th>$Gfont <font size='1'>NoConform</font></th>";
        echo "<th>$Gfont <font size='1'>Status</font></th>";
        echo "<th>$Gfont <font size='1'>Atendio</font></th>";
        echo "<th>$Gfont <font size='1'>Proceso</font></th>";
        echo "<th>$Gfont <font size='1'>Capturo</font></th>";
        echo "<th>$Gfont <font size='1'>Imprimio</font></th>";
        ...
        echo "<th>$Gfont <font size='1'>Obs</font></th>";
		  ...
		  while($registro=mysql_fetch_array($res))		{
            ...
            if($He[status]=='Entregada'){
			  if($registro[depto] <> 2 ){
			  		if($registro[creapdf]=='pdf'){
						 ...
						 echo "<td align='center'><a href=javascript:wingral('resultapdf.php?clnk=$clnk&Orden=$busca&Estudio=$registro[estudio]&Depto=TERMINADA&op=im&alterno=$registro[alterno]')><font size='1'>PDF</font></a></td>";
				 	}else{

						 echo "<td align='center'><a class='pg' href=javascript:wingral('estdeptoimp.php?clnk=$clnk&Orden=$busca&Estudio=$registro[estudio]&Depto=TERMINADA&op=im&reimp=1&alterno=$registro[alterno]')><img src='lib/print.png' alt='Imprime resultados' border='0'></a></td>";
					}
            ...
            //******************************** M U E S T R A S **************************************************//
            if($muestras==1 and $registro[estudio]==$Estudio){

	            echo "<form name='frmuestras' method='get' action=" . $_SERVER['PHP_SELF'] . ">";

	            echo "<td align='center'>";
	            echo "<select name='nmuestras'>";
	            ...
	            echo "<input type='hidden' name='muestras' value='0'>";
	            ...
	            echo "<input type='hidden' name='status' value='TOMA/REALIZ'>";
	            echo "<input type='hidden' name='Suc' value=$suc>";
	            echo "<input class='boton' type='submit' name='Ok' value='Ok'></td>";
	            echo "</form>";

            }else{

				if($registro[indmuestras]=='Varias'){

	              	if($registro[statustom]=='TOMA/REALIZ'){				
		               echo "<td align='center'>$Gfont <font size='1'>$registro[nmuestras]</font><img src='lib/slc.png'></td>";
		            }else{
						if($registro[statustom]==''){

		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]&muestras=1'>OK</b></a></td>";

						}else{
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]&muestras=1'><img src='lib/iconfalse.gif'></b></a></td>";
						}
		            }  
					...
					if($registro[statustom]=='TOMA/REALIZ'){				
		               echo "<td align='center'>$Gfont<img src='lib/slc.png'></td>";
						...
						if($registro[statustom]==''){
		               		...
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]'>OK</b></a></td>";

						}else{
		               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=TOMA/REALIZ&Suc=$He[suc]'><img src='lib/iconfalse.gif'></b></a></td>";
						}
		            }   
...
*/
			if($registro[statustom]=='RECOLECCION'){	
				...
				echo "<td align='center'>$Gfont<a class='pg' href=javascript:winuni('recoleccion.php?Orden=$busca&Estudio=$registro[estudio]')><img src='lib/slc.png'></a></td>";
			
              // echo "<td align='center'>$Gfont<img src='lib/slc.png'></td>";
            }else{
				if($registro[statustom]==''){

					echo "<td align='center'>$Gfont<a class='pg' href=javascript:winuni('recoleccion.php?Orden=$busca&Estudio=$registro[estudio]')>OK</a></td>";

               		//echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=RECOLECCION&Suc=$He[suc]'>OK</b></a></td>";
				}else{

					echo "<td align='center'>$Gfont<a class='pg' href=javascript:winuni('recoleccion.php?Orden=$busca&Estudio=$registro[estudio]')><img src='lib/iconfalse.gif'></a></td>";

               		//echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&regis=1&status=RECOLECCION&Suc=$He[suc]'><img src='lib/iconfalse.gif'></b></a></td>";
				}
            }   
			...
			if($registro[statustom]=='PENDIENTE'){				
               echo "<td align='center'>$Gfont<img src='lib/slc.png'></td>";
				...
				if($registro[statustom]==''){
               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&status=PENDIENTE'>OK</b></a></td>";
				}else{

               		echo "<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=1&Estudio=$registro[estudio]&status=PENDIENTE'><img src='lib/iconfalse.gif'></b></a></td>";
				}
            }
			if($registro[status]=='PENDIENTE'){
             ...
             if($registro[noconformidad]<>''){				
          		echo "<td align='center'>$Gfont<a class='pg' href=javascript:winuni2('noconformidad.php?Orden=$busca&Estudio=$registro[estudio]')><img src='images/ErrorCircle.png' border='0'></a></td>";
            }else{
          		echo "<td align='center'>$Gfont<a class='pg' href=javascript:winuni2('noconformidad.php?Orden=$busca&Estudio=$registro[estudio]')><img src='images/all.png' border='0' width='16'></a></td>";
            }  

            echo "<td>$Gfont5 <font size='1'>$registro[status]</font></td>";
            echo "<td>$Gfont $registro[usrest]</font></td>";
            echo "<td>$Gfont - </font></td>";
...
echo "<tr><td>";
echo " &nbsp; <a class='pg' href='ordenespro.php?Suc=$Suc&pagina=$pagina&NC=$NC&busca=$busca'><img src='lib/regresa.jpg' border=0></a> ";
echo "</td><td>";
echo " &nbsp; &nbsp; <a class='pg' href=javascript:Ventana('impeti2.php?op=3&busca=$busca')>Etiquetas</a>";
echo "</td><td>";

if($Usr=='nazario' or $Usr=='Javier' or $Usr=='emilio'){
	echo "<form name='form2' method='post' action='ordenesdet.php?op=Ag&busca=$busca'>";
...
echo "<table align='center' width='100%' border='0' cellspacing='1' cellpadding='0'>";
echo "<tr><td align='center'><form name='form1' method='post' action='ordenesdet.php'>";
echo "$Gfont Observaciones:&nbsp;";
//echo "$Gfont <strong>Observaciones:&nbsp;</strong>";
echo "<TEXTAREA NAME='Observaciones2' cols='70' rows='3' readonly>$He[observaciones]</TEXTAREA>";
echo "</td></tr>";
echo "<tr><td align='center'>";
echo "$Gfont Agregar otras Obs:&nbsp;";
echo "<TEXTAREA NAME='Observaciones' cols='70' rows='3'></TEXTAREA>";
echo "</td></tr>"; 
echo "<tr><td align='center'>";
echo " &nbsp;  &nbsp;  &nbsp;  &nbsp; <a href=javascript:wingral('logobs.php?busca=$busca')><font size='1'> *** Detalle de modificaciones ***</a>  </td></tr>";
echo "</td></tr>";
echo "<tr><td align='center'>";
...
// ++++++++++++++++++++ Tabla de insumos +++++++++++++++++++
  ...
  $cSqlE     = "SELECT otd.estudio as estudio,est.descripcion,estd.estudio as estudios,estd.producto,estd.cantidad,invl.descripcion,est.estpropio,invl.clave
   ...
   if(!$res2=mysql_query($cSqlE." ORDER BY ".$OrdenDef)){
    ...
    echo "<form name='form5' method='get' action='ordenesdet.php'>";
...
//			 if(!$resF==mysql_query($cSqlF." ORDER BY ".$OrdenD)){
				...
				$unidad=$sucursal;
				$pcs="<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=$unidad&pcs=1'>OK - $total</b></a></td>";
				...
				if($registro3(pcs)=='1'){
					...
					$pcs="<td align='center'>$Gfont<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=$unidad&pcs=1'>OK</b></a></td>";
				}
			}
			...
			if($intext=='Interno'){
				...
				<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=Externo&unidad=$unidad'> Externo / </a>
				<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=Mixto&unidad=$unidad'> Mixto </b></a></td>";
			}elseif($intext=='Externo'){
				echo "<td align='center'>$Gfont <a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=Interno&unidad=$unidad'>Interno / </a>
			...
			if($unidad=='1'){
				...
				<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=2'> OHF / </a>
				<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=3'> TPX / </a>
				<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=4'> RYS / </a>			
				<a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=5'> EXT </a>				
				</b></td>";
			}elseif($unidad=='2'){
				echo "<td align='center'>$Gfont <a class='pg' href='ordenesdet.php?busca=$busca&pagina=$pagina&op=pcs&Estudio=$registro2[estudio]&insumo=$registro2[clave]&cnt=$cantidad3&intext=$intext&unidad=1'>LCD / </a>
