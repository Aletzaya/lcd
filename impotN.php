...
$OtA    =   mysql_query("select otnvas.cliente,otnvas.medico,otnvas.medicon,otnvas.fechae,otnvas.inst,otnvas.fechae,
            inst.nombre,otnvas.servicio,otnvas.horae,otnvas.horae,otnvas.horae,otnvas.abono
            from otnvas,inst 
...
<table width="100%" height="813" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="Estilo18">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td>&nbsp;</td>
    <td colspan="2" rowspan="2"><?php echo "<form action='ordenesnvasN.php?Vta=$Vta' method='post' name='Regresa' class='Estilo31'>"?>
          <input type="submit" name="Regresa" value="Regresar OT">
    </form></td>
        <td colspan="2" rowspan="2"><?php echo "<form action='ordenesnvasN.php?Vta=$Vta&op=Fnot' method='post' name='Genera' class='Estilo31'>"?>
          <input type="submit" name="Genera" value="GENERA OT">
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td colspan="3"><span class="Estilo31">&nbsp;<?php echo $Usr;?></span></td>
  </tr>
  <tr bordercolor="#FFFFFF">
    <td height="26" colspan="2"><span class="Estilo31"><?php echo $Otd[0];?></span></td>
    <td><span class="Estilo31"><?php echo substr($Otd[1],0,28);?></span></td>
...
?>
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td bordercolor="#CCCCCC"><div align="right" class="Estilo31"><strong>$&nbsp;<?php echo number_format($Ot[abono],"2");?></strong></div></td>
    <td>&nbsp;</td>
    <td><span class="Estilo31"><?php echo $Otd[0];?></span></td>
    <td><div align="center" class="Estilo31">
        <?php if($Otd[3]=='0' or $Otd[0]==''){echo " ";} else{echo number_format ($Otd[3])." %";}?>
  ...
  <tr bordercolor="#FFFFFF">
    ...
    <td bordercolor="#CCCCCC"><div align="right" class="Estilo31"><strong>$&nbsp;<?php echo number_format($Cja[0]-$Ot[abono],"2");?></strong></div></td>
    <td>&nbsp;</td>
    <td><span class="Estilo31"><?php echo $Otd[0];?></span></td>
    <td><div align="center" class="Estilo31">
        <?php if($Otd[3]=='0' or $Otd[0]==''){echo " ";} else{echo number_format ($Otd[3])." %";}?>
  ...
  <tr bordercolor="#FFFFFF">
    <td colspan="3" rowspan="11" bordercolor="#CCCCCC"><div align="center" class="Estilo31"></div>
        <div align="center" class="Estilo31"><img src="Promodic2017.jpg" width="300" height="241"></div></td>
  ...
  <tr>
    ...
    <td bordercolor="#CCCCCC"><div align="right" class="Estilo31"><strong>$&nbsp;<?php echo number_format($Ot[0],"2"); ?></strong></div></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
