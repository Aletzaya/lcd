<?php
  ...
  $op     = $_REQUEST[op];
  $Id     = 3; 										                 //Numero de query dentro de la base de datos
  ...
  $cSql  = "SELECT $Qry[campos],files.id FROM $Qry[froms] WHERE files.descripcion like '%$busca%' $Qry[filtro]";
...
<?php
 ...
 if(!$res=mysql_query($cSql)){
      ...
      while($rg=mysql_fetch_array($res)){
           ...
           echo "<td align='center'><a href='$cLinkd?busca=$rg[id]'><img src='lib/browse.png' alt='Detalle' border='0'></td>";
